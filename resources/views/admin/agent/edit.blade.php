...
<div class="table-container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route("admin.agent.update", [$category->id]) }}" id="addform" method="POSt" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" id="url_root" name="url_root" class="form-control" value="{{ route("admin.agent.update", [$category->id]) }}">
