                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($user->id); ?>">
                            ...
                            <td><label class="custom-toggle">
                                    <input type="checkbox" onchange="update('mss_user','status',0,<?php echo e($user->id); ?>)" <?php echo e($user->status==1 ? 'checked' : ''); ?> >
                            ...
                            <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.users.show', $user->id)); ?>">
                                ...
                                <button class="btn btn-xs btn-danger" onclick="deletethis('mss_user',<?php echo e($user->id); ?>)">
                                Delete
                                </button>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RealEstate\resources\views/admin/users/index.blade.php ENDPATH**/ ?>