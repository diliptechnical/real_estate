...
<div class="table-container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route("admin.property.store")); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-6 <?php echo e($errors->has('state') ? 'has-error' : ''); ?>">
                        ...
                        <select id="state" onchange="getCity()" name="state" class="form-control">
                    ...
                    <div class="form-group col-md-6 ">
                        ...
                        <select id="property_type" onChange="getProperty()" name="property_type" class="form-control">
                ...
                <div class="form-group col-sm-6  <?php echo e($errors->has('front_image') ? 'has-error' : ''); ?>">
                    <label for="price">Main Image</label>
                ...
                <div class="form-group col-sm-6 <?php echo e($errors->has('floor_plan') ? 'has-error' : ''); ?>">
                <label for="price">Floor Plan (File size supported under 25MB ) </label>
                    <input type="file" id="plan_images" multiple name="plan_images" class="form-control" value="<?php echo e(old('plan_images', isset($category) ? $category->floor_plan : '')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RealEstate\resources\views/admin/property/create.blade.php ENDPATH**/ ?>