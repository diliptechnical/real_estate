 ...
 */
}(function (aA, aP) { var aL = aA.GreenSockGlobals = aA.GreenSockGlobals || aA; if (!aL.TweenLite) { var aB; var aC; var aG; var aT; var aF; var aI = function (a) { var d; var b = a.split('.'); var c = aL; for (d = 0; b.length > d; d++) { c[b[d]] = c = c[b[d]] || {} } return c }; var aM = aI('com.greensock'); var aU = 1e-10; var az = function (b) { var d; var a = []; var c = b.length; for (d = 0; d !== c; a.push(b[d++])) {} return a }; var aH = function () {}; var aO = (function () { var a = Object.prototype.toString; var b = a.call([]); return function (c) { return c != null && (c instanceof Array || typeof c === 'object' && !!c.push && a.call(c) === b) } }()); var aR = {}; var aE = function (c, d, g, b) { this.sc = aR[c] ? aR[c].sc : [], aR[c] = this, this.gsClass = null, this.func = g; var f = []; this.check = function (l) { for (var k, j, a, n, o = d.length, i = o; --o > -1;) { (k = aR[d[o]] || new aE(d[o], [])).gsClass ? (f[o] = k.gsClass, i--) : l && k.sc.push(this) } if (i === 0 && g) { for (j = ('com.greensock.' + c).split('.'), a = j.pop(), n = aI(j.join('.'))[a] = this.gsClass = g.apply(g, f), b && (aL[a] = n, typeof define === 'function' && define.amd ? define((aA.GreenSockAMDPath ? aA.GreenSockAMDPath + '/' : '') + c.split('.').pop(), [], function () { return n }) : c === aP && typeof module !== 'undefined' && module.exports && (module.exports = n)), o = 0; this.sc.length > o; o++) { this.sc[o].check() } } }, this.check(!0) }; var aQ = aA._gsDefine = function (b, d, a, c) { return new aE(b, d, a, c) }; var ay = aM._class = function (b, c, a) { return c = c || function () {}, aQ(b, [], function () { return c }, a), c }; aQ.globals = aL; var aN = [0, 0, 1, 1]; var Y = []; var av = ay('easing.Ease', function (b, d, a, c) { this._func = b, this._type = a || 0, this._power = c || 0, this._params = d ? aN.concat(d) : aN }, !0); var ax = av.map = {}; var ac = av.register = function (p, h, g, q) { for (var b, d, j, c, f = h.split(','), k = f.length, m = (g || 'easeIn,easeOut,easeInOut').split(','); --k > -1;) { for (d = f[k], b = q ? ay('easing.' + d, null, !0) : aM.easing[d] || {}, j = m.length; --j > -1;) { c = m[j], ax[d + '.' + c] = ax[c + d] = b[c] = p.getRatio ? p : p[c] || new p() } } }; for (aG = av.prototype, aG._calcEnd = !1, aG.getRatio = function (b) { if (this._func) { return this._params[0] = b, this._func.apply(null, this._params) } var d = this._type; var a = this._power; var c = d === 1 ? 1 - b : d === 2 ? b : b < 0.5 ? 2 * b : 2 * (1 - b); return a === 1 ? c *= c : a === 2 ? c *= c * c : a === 3 ? c *= c * c * c : a === 4 && (c *= c * c * c * c), d === 1 ? 1 - c : d === 2 ? c : b < 0.5 ? c / 2 : 1 - c / 2 }, aB = ['Linear', 'Quad', 'Cubic', 'Quart', 'Quint,Strong'], aC = aB.length; --aC > -1;) { aG = aB[aC] + ',Power' + aC, ac(new av(null, null, 1, aC), aG, 'easeOut', !0), ac(new av(null, null, 2, aC), aG, 'easeIn' + (aC === 0 ? ',easeNone' : '')), ac(new av(null, null, 3, aC), aG, 'easeInOut') }ax.linear = aM.easing.Linear.easeIn, ax.swing = aM.easing.Quad.easeInOut; var aS = ay('events.EventDispatcher', function (a) { this._listeners = {}, this._eventTarget = a || this }); aG = aS.prototype, aG.addEventListener = function (k, g, d, m, a) { a = a || 0; var b; var c; var f = this._listeners[k]; var j = 0; for (f == null && (this._listeners[k] = f = []), c = f.length; --c > -1;) { b = f[c], b.c === g && b.s === d ? f.splice(c, 1) : j === 0 && a > b.pr && (j = c + 1) }f.splice(j, 0, { c: g, s: d, up: m, pr: a }), this !== aT || aF || aT.wake() }, aG.removeEventListener = function (b, d) { var a; var c = this._listeners[b]; if (c) { for (a = c.length; --a > -1;) { if (c[a].c === d) { return c.splice(a, 1), void 0 } } } }, aG.dispatchEvent = function (b) { var f; var a; var c; var d = this._listeners[b]; if (d) { for (f = d.length, a = this._eventTarget; --f > -1;) { c = d[f], c && (c.up ? c.c.call(c.s || a, { type: b, target: a }) : c.c.call(c.s || a)) } } }; var aJ = aA.requestAnimationFrame; var ar = aA.cancelAnimationFrame; var Z = Date.now || function () { return (new Date()).getTime() }; var aw = Z(); for (aB = ['ms', 'moz', 'webkit', 'o'], aC = aB.length; --aC > -1 && !aJ;) { aJ = aA[aB[aC] + 'RequestAnimationFrame'], ar = aA[aB[aC] + 'CancelAnimationFrame'] || aA[aB[aC] + 'CancelRequestAnimationFrame'] }ay('Ticker', function (y, q) { var k; var z; var a; var g; var j; var m = this; var x = Z(); var o = q !== !1 && aJ; var w = 500; var b = 33; var v = function (d) { var f; var c; var h = Z() - aw; h > w && (x += h - b), aw += h, m.time = (aw - x) / 1000, f = m.time - j, (!k || f > 0 || d === !0) && (m.frame++, j += f + (f >= g ? 0.004 : g - f), c = !0), d !== !0 && (a = z(v)), c && m.dispatchEvent('tick') }; aS.call(m), m.time = m.frame = 0, m.tick = function () { v(!0) }, m.lagSmoothing = function (c, d) { w = c || 1 / aU, b = Math.min(d, w, 0) }, m.sleep = function () { a != null && (o && ar ? ar(a) : clearTimeout(a), z = aH, a = null, m === aT && (aF = !1)) }, m.wake = function () { a !== null ? m.sleep() : m.frame > 10 && (aw = Z() - w + 5), z = k === 0 ? aH : o && aJ ? aJ : function (c) { return setTimeout(c, 0 | 1000 * (j - m.time) + 1) }, m === aT && (aF = !0), v(2) }, m.fps = function (c) { return arguments.length ? (k = c, g = 1 / (k || 60), j = this.time + g, m.wake(), void 0) : k }, m.useRAF = function (c) { return arguments.length ? (m.sleep(), o = c, m.fps(k), void 0) : o }, m.fps(y), setTimeout(function () { o && (!a || m.frame < 5) && m.useRAF(!1) }, 1500) }), aG = aM.Ticker.prototype = new aM.events.EventDispatcher(), aG.constructor = aM.Ticker; var aa = ay('core.Animation', function (b, c) { if (this.vars = c = c || {}, this._duration = this._totalDuration = b || 0, this._delay = Number(c.delay) || 0, this._timeScale = 1, this._active = c.immediateRender === !0, this.data = c.data, this._reversed = c.reversed === !0, aq) { aF || aT.wake(); var a = this.vars.useFrames ? aD : aq; a.add(this, a._time), this.vars.paused && this.paused(!0) } }); aT = aa.ticker = new aM.Ticker(), aG = aa.prototype, aG._dirty = aG._gc = aG._initted = aG._paused = !1, aG._totalTime = aG._time = 0, aG._rawPrevTime = -1, aG._next = aG._last = aG._onUpdate = aG._timeline = aG.timeline = null, aG._paused = !1; var ap = function () { aF && Z() - aw > 2000 && aT.wake(), setTimeout(ap, 2000) }; ap(), aG.play = function (a, b) { return a != null && this.seek(a, b), this.reversed(!1).paused(!1) }, aG.pause = function (a, b) { return a != null && this.seek(a, b), this.paused(!0) }, aG.resume = function (a, b) { return a != null && this.seek(a, b), this.paused(!1) }, aG.seek = function (a, b) { return this.totalTime(Number(a), b !== !1) }, aG.restart = function (a, b) { return this.reversed(!1).paused(!1).totalTime(a ? -this._delay : 0, b !== !1, !0) }, aG.reverse = function (a, b) { return a != null && this.seek(a || this.totalDuration(), b), this.reversed(!0).paused(!1) }, aG.render = function () {}, aG.invalidate = function () { return this._time = this._totalTime = 0, this._initted = this._gc = !1, this._rawPrevTime = -1, (this._gc || !this.timeline) && this._enabled(!0), this }, aG.isActive = function () { var b; var c = this._timeline; var a = this._startTime; return !c || !this._gc && !this._paused && c.isActive() && (b = c.rawTime()) >= a && a + this.totalDuration() / this._timeScale > b }, aG._enabled = function (a, b) { return aF || aT.wake(), this._gc = !a, this._active = this.isActive(), b !== !0 && (a && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !a && this.timeline && this._timeline._remove(this, !0)), !1 }, aG._kill = function () { return this._enabled(!1, !1) }, aG.kill = function (a, b) { return this._kill(a, b), this }, aG._uncache = function (a) { for (var b = a ? this : this.timeline; b;) { b._dirty = !0, b = b.timeline } return this }, aG._swapSelfInParams = function (b) { for (var c = b.length, a = b.concat(); --c > -1;) { b[c] === '{self}' && (a[c] = this) } return a }, aG.eventCallback = function (b, f, a, c) { if ((b || '').substr(0, 2) === 'on') { var d = this.vars; if (arguments.length === 1) { return d[b] }f == null ? delete d[b] : (d[b] = f, d[b + 'Params'] = aO(a) && a.join('').indexOf('{self}') !== -1 ? this._swapSelfInParams(a) : a, d[b + 'Scope'] = c), b === 'onUpdate' && (this._onUpdate = f) } return this }, aG.delay = function (a) { return arguments.length ? (this._timeline.smoothChildTiming && this.startTime(this._startTime + a - this._delay), this._delay = a, this) : this._delay }, aG.duration = function (a) { return arguments.length ? (this._duration = this._totalDuration = a, this._uncache(!0), this._timeline.smoothChildTiming && this._time > 0 && this._time < this._duration && a !== 0 && this.totalTime(this._totalTime * (a / this._duration), !0), this) : (this._dirty = !1, this._duration) }, aG.totalDuration = function (a) { return this._dirty = !1, arguments.length ? this.duration(a) : this._totalDuration }, aG.time = function (a, b) { return arguments.length ? (this._dirty && this.totalDuration(), this.totalTime(a > this._duration ? this._duration : a, b)) : this._time }, aG.totalTime = function (b, f, a) { if (aF || aT.wake(), !arguments.length) { return this._totalTime } if (this._timeline) { if (b < 0 && !a && (b += this.totalDuration()), this._timeline.smoothChildTiming) { this._dirty && this.totalDuration(); var c = this._totalDuration; var d = this._timeline; if (b > c && !a && (b = c), this._startTime = (this._paused ? this._pauseTime : d._time) - (this._reversed ? c - b : b) / this._timeScale, d._dirty || this._uncache(!1), d._timeline) { for (;d._timeline;) { d._timeline._time !== (d._startTime + d._totalTime) / d._timeScale && d.totalTime(d._totalTime, !0), d = d._timeline } } } this._gc && this._enabled(!0, !1), (this._totalTime !== b || this._duration === 0) && (this.render(b, f, !1), au.length && af()) } return this }, aG.progress = aG.totalProgress = function (a, b) { return arguments.length ? this.totalTime(this.duration() * a, b) : this._time / this.duration() }, aG.startTime = function (a) { return arguments.length ? (a !== this._startTime && (this._startTime = a, this.timeline && this.timeline._sortChildren && this.timeline.add(this, a - this._delay)), this) : this._startTime }, aG.endTime = function (a) { return this._startTime + (a != 0 ? this.totalDuration() : this.duration()) / this._timeScale }, aG.timeScale = function (b) { if (!arguments.length) { return this._timeScale } if (b = b || aU, this._timeline && this._timeline.smoothChildTiming) { var c = this._pauseTime; var a = c || c === 0 ? c : this._timeline.totalTime(); this._startTime = a - (a - this._startTime) * this._timeScale / b } return this._timeScale = b, this._uncache(!1) }, aG.reversed = function (a) { return arguments.length ? (a != this._reversed && (this._reversed = a, this.totalTime(this._timeline && !this._timeline.smoothChildTiming ? this.totalDuration() - this._totalTime : this._totalTime, !0)), this) : this._reversed }, aG.paused = function (b) { if (!arguments.length) { return this._paused } if (b != this._paused && this._timeline) { aF || b || aT.wake(); var d = this._timeline; var a = d.rawTime(); var c = a - this._pauseTime; !b && d.smoothChildTiming && (this._startTime += c, this._uncache(!1)), this._pauseTime = b ? a : null, this._paused = b, this._active = this.isActive(), !b && c !== 0 && this._initted && this.duration() && this.render(d.smoothChildTiming ? this._totalTime : (a - this._startTime) / this._timeScale, !0, !0) } return this._gc && !b && this._enabled(!0, !1), this }; var ao = ay('core.SimpleTimeline', function (a) { aa.call(this, 0, a), this.autoRemoveChildren = this.smoothChildTiming = !0 }); aG = ao.prototype = new aa(), aG.constructor = ao, aG.kill()._gc = !1, aG._first = aG._last = aG._recent = null, aG._sortChildren = !1, aG.add = aG.insert = function (b, d) { var a, c; if (b._startTime = Number(d || 0) + b._delay, b._paused && this !== b._timeline && (b._pauseTime = b._startTime + (this.rawTime() - b._startTime) / b._timeScale), b.timeline && b.timeline._remove(b, !0), b.timeline = b._timeline = this, b._gc && b._enabled(!0, !0), a = this._last, this._sortChildren) { for (c = b._startTime; a && a._startTime > c;) { a = a._prev } } return a ? (b._next = a._next, a._next = b) : (b._next = this._first, this._first = b), b._next ? b._next._prev = b : this._last = b, b._prev = a, this._recent = b, this._timeline && this._uncache(!0), this }, aG._remove = function (a, b) { return a.timeline === this && (b || a._enabled(!1, !0), a._prev ? a._prev._next = a._next : this._first === a && (this._first = a._next), a._next ? a._next._prev = a._prev : this._last === a && (this._last = a._prev), a._next = a._prev = a.timeline = null, a === this._recent && (this._recent = this._last), this._timeline && this._uncache(!0)), this }, aG.render = function (b, f, a) { var c; var d = this._first; for (this._totalTime = this._time = this._rawPrevTime = b; d;) { c = d._next, (d._active || b >= d._startTime && !d._paused) && (d._reversed ? d.render((d._dirty ? d.totalDuration() : d._totalDuration) - (b - d._startTime) * d._timeScale, f, a) : d.render((b - d._startTime) * d._timeScale, f, a)), d = c } }, aG.rawTime = function () { return aF || aT.wake(), this._totalTime }; var aj = ay('TweenLite', function (h, d, f) { if (aa.call(this, d, f), this.render = aj.prototype.render, h == null) { throw 'Cannot tween a null target.' } this.target = h = typeof h !== 'string' ? h : aj.selector(h) || h; var g; var k; var c; var j = h.jquery || h.length && h !== aA && h[0] && (h[0] === aA || h[0].nodeType && h[0].style && !h.nodeType); var b = this.vars.overwrite; if (this._overwrite = b = b == null ? ab[aj.defaultOverwrite] : typeof b === 'number' ? b >> 0 : ab[b], (j || h instanceof Array || h.push && aO(h)) && typeof h[0] !== 'number') { for (this._targets = c = az(h), this._propLookup = [], this._siblings = [], g = 0; c.length > g; g++) { k = c[g], k ? typeof k !== 'string' ? k.length && k !== aA && k[0] && (k[0] === aA || k[0].nodeType && k[0].style && !k.nodeType) ? (c.splice(g--, 1), this._targets = c = c.concat(az(k))) : (this._siblings[g] = at(k, this, !1), b === 1 && this._siblings[g].length > 1 && ak(k, this, null, 1, this._siblings[g])) : (k = c[g--] = aj.selector(k), typeof k === 'string' && c.splice(g + 1, 1)) : c.splice(g--, 1) } } else { this._propLookup = {}, this._siblings = at(h, this, !1), b === 1 && this._siblings.length > 1 && ak(h, this, null, 1, this._siblings) }(this.vars.immediateRender || d === 0 && this._delay === 0 && this.vars.immediateRender !== !1) && (this._time = -aU, this.render(-this._delay)) }, !0); var an = function (a) { return a && a.length && a !== aA && a[0] && (a[0] === aA || a[0].nodeType && a[0].style && !a.nodeType) }; var ad = function (b, d) { var a; var c = {}; for (a in b) { al[a] || a in d && a !== 'transform' && a !== 'x' && a !== 'y' && a !== 'width' && a !== 'height' && a !== 'className' && a !== 'border' || !(!X[a] || X[a] && X[a]._autoCSS) || (c[a] = b[a], delete b[a]) }b.css = c }; aG = aj.prototype = new aa(), aG.constructor = aj, aG.kill()._gc = !1, aG.ratio = 0, aG._firstPT = aG._targets = aG._overwrittenProps = aG._startAt = null, aG._notifyPluginsOfEnabled = aG._lazy = !1, aj.version = '1.14.2', aj.defaultEase = aG._ease = new av(null, null, 1, 1), aj.defaultOverwrite = 'auto', aj.ticker = aT, aj.autoSleep = !0, aj.lagSmoothing = function (a, b) { aT.lagSmoothing(a, b) }, aj.selector = aA.$ || aA.jQuery || function (b) { var a = aA.$ || aA.jQuery; return a ? (aj.selector = a, a(b)) : typeof document === 'undefined' ? b : document.querySelectorAll ? document.querySelectorAll(b) : document.getElementById(b.charAt(0) === '#' ? b.substr(1) : b) }; var au = []; var ag = {}; var ae = aj._internals = { isArray: aO, isSelector: an, lazyTweens: au }; var X = aj._plugins = {}; var am = ae.tweenLookup = {}; var aK = 0; var al = ae.reservedProps = { ease: 1, delay: 1, overwrite: 1, onComplete: 1, onCompleteParams: 1, onCompleteScope: 1, useFrames: 1, runBackwards: 1, startAt: 1, onUpdate: 1, onUpdateParams: 1, onUpdateScope: 1, onStart: 1, onStartParams: 1, onStartScope: 1, onReverseComplete: 1, onReverseCompleteParams: 1, onReverseCompleteScope: 1, onRepeat: 1, onRepeatParams: 1, onRepeatScope: 1, easeParams: 1, yoyo: 1, immediateRender: 1, repeat: 1, repeatDelay: 1, data: 1, paused: 1, reversed: 1, autoCSS: 1, lazy: 1, onOverwrite: 1 }; var ab = { none: 0, all: 1, auto: 2, concurrent: 3, allOnStart: 4, preexisting: 5, true: 1, false: 0 }; var aD = aa._rootFramesTimeline = new ao(); var aq = aa._rootTimeline = new ao(); var af = ae.lazyRender = function () { var a; var b = au.length; for (ag = {}; --b > -1;) { a = au[b], a && a._lazy !== !1 && (a.render(a._lazy[0], a._lazy[1], !0), a._lazy = !1) }au.length = 0 }; aq._startTime = aT.time, aD._startTime = aT.frame, aq._active = aD._active = !0, setTimeout(af, 1), aa._updateRoot = aj.render = function () { var b, c, a; if (au.length && af(), aq.render((aT.time - aq._startTime) * aq._timeScale, !1, !1), aD.render((aT.frame - aD._startTime) * aD._timeScale, !1, !1), au.length && af(), !(aT.frame % 120)) { for (a in am) { for (c = am[a].tweens, b = c.length; --b > -1;) { c[b]._gc && c.splice(b, 1) }c.length === 0 && delete am[a] } if (a = aq._first, (!a || a._paused) && aj.autoSleep && !aD._first && aT._listeners.tick.length === 1) { for (;a && a._paused;) { a = a._next }a || aT.sleep() } } }, aT.addEventListener('tick', aa._updateRoot); var at = function (b, f, a) { var c; var d; var g = b._gsTweenID; if (am[g || (b._gsTweenID = g = 't' + aK++)] || (am[g] = { target: b, tweens: [] }), f && (c = am[g].tweens, c[d = c.length] = f, a)) { for (;--d > -1;) { c[d] === f && c.splice(d, 1) } } return am[g].tweens }; var ah = function (d, h, c, f) { var g; var j; var b = d.vars.onOverwrite; return b && (g = b(d, h, c, f)), b = aj.onOverwrite, b && (j = b(d, h, c, f)), g !== !1 && j !== !1 }; var ak = function (A, w, p, B, b) { var g, y, d, k; if (B === 1 || B >= 4) { for (k = b.length, g = 0; k > g; g++) { if ((d = b[g]) !== w) { d._gc || ah(d, w) && d._enabled(!1, !1) && (y = !0) } else { if (B === 5) { break } } } return y } var q; var z = w._startTime + aU; var j = []; var v = 0; var x = w._duration === 0; for (g = b.length; --g > -1;) { (d = b[g]) === w || d._gc || d._paused || (d._timeline !== w._timeline ? (q = q || ai(w, 0, x), ai(d, q, x) === 0 && (j[v++] = d)) : z >= d._startTime && d._startTime + d.totalDuration() / d._timeScale > z && ((x || !d._initted) && z - d._startTime <= 2e-10 || (j[v++] = d))) } for (g = v; --g > -1;) { if (d = j[g], B === 2 && d._kill(p, A, w) && (y = !0), B !== 2 || !d._firstPT && d._initted) { if (B !== 2 && !ah(d, w)) { continue }d._enabled(!1, !1) && (y = !0) } } return y }; var ai = function (b, f, a) { for (var c = b._timeline, d = c._timeScale, g = b._startTime; c._timeline;) { if (g += c._startTime, d *= c._timeScale, c._paused) { return -100 }c = c._timeline } return g /= d, g > f ? g - f : a && g === f || !b._initted && 2 * aU > g - f ? aU : (g += b.totalDuration() / b._timeScale / d) > f + aU ? 0 : g - f - aU }; aG._init = function () { var p; var k; var g; var q; var b; var d = this.vars; var m = this._overwrittenProps; var c = this._duration; var f = !!d.immediateRender; var j = d.ease; if (d.startAt) { this._startAt && (this._startAt.render(-1, !0), this._startAt.kill()), b = {}; for (q in d.startAt) { b[q] = d.startAt[q] } if (b.overwrite = !1, b.immediateRender = !0, b.lazy = f && d.lazy !== !1, b.startAt = b.delay = null, this._startAt = aj.to(this.target, 0, b), f) { if (this._time > 0) { this._startAt = null } else { if (c !== 0) { return } } } } else { if (d.runBackwards && c !== 0) { if (this._startAt) { this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null } else { this._time !== 0 && (f = !1), g = {}; for (q in d) { al[q] && q !== 'autoCSS' || (g[q] = d[q]) } if (g.overwrite = 0, g.data = 'isFromStart', g.lazy = f && d.lazy !== !1, g.immediateRender = f, this._startAt = aj.to(this.target, 0, g), f) { if (this._time === 0) { return } } else { this._startAt._init(), this._startAt._enabled(!1), this.vars.immediateRender && (this._startAt = null) } } } } if (this._ease = j = j ? j instanceof av ? j : typeof j === 'function' ? new av(j, d.easeParams) : ax[j] || aj.defaultEase : aj.defaultEase, d.easeParams instanceof Array && j.config && (this._ease = j.config.apply(j, d.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets) { for (p = this._targets.length; --p > -1;) { this._initProps(this._targets[p], this._propLookup[p] = {}, this._siblings[p], m ? m[p] : null) && (k = !0) } } else { k = this._initProps(this.target, this._propLookup, this._siblings, m) } if (k && aj._onPluginEvent('_onInitAllProps', this), m && (this._firstPT || typeof this.target !== 'function' && this._enabled(!1, !1)), d.runBackwards) { for (g = this._firstPT; g;) { g.s += g.c, g.c = -g.c, g = g._next } } this._onUpdate = d.onUpdate, this._initted = !0 }, aG._initProps = function (k, g, q, b) { var d, m, c, f, j, p; if (k == null) { return !1 }ag[k._gsTweenID] && af(), this.vars.css || k.style && k !== aA && k.nodeType && X.css && this.vars.autoCSS !== !1 && ad(this.vars, k); for (d in this.vars) { if (p = this.vars[d], al[d]) { p && (p instanceof Array || p.push && aO(p)) && p.join('').indexOf('{self}') !== -1 && (this.vars[d] = p = this._swapSelfInParams(p, this)) } else { if (X[d] && (f = new X[d]())._onInitTween(k, this.vars[d], this)) { for (this._firstPT = j = { _next: this._firstPT, t: f, p: 'setRatio', s: 0, c: 1, f: !0, n: d, pg: !0, pr: f._priority }, m = f._overwriteProps.length; --m > -1;) { g[f._overwriteProps[m]] = this._firstPT }(f._priority || f._onInitAllProps) && (c = !0), (f._onDisable || f._onEnable) && (this._notifyPluginsOfEnabled = !0) } else { this._firstPT = g[d] = j = { _next: this._firstPT, t: k, p: d, f: typeof k[d] === 'function', n: d, pg: !1, pr: 0 }, j.s = j.f ? k[d.indexOf('set') || typeof k['get' + d.substr(3)] !== 'function' ? d : 'get' + d.substr(3)]() : parseFloat(k[d]), j.c = typeof p === 'string' && p.charAt(1) === '=' ? parseInt(p.charAt(0) + '1', 10) * Number(p.substr(2)) : Number(p) - j.s || 0 } }j && j._next && (j._next._prev = j) } return b && this._kill(b, k) ? this._initProps(k, g, q, b) : this._overwrite > 1 && this._firstPT && q.length > 1 && ak(k, this, g, this._overwrite, q) ? (this._kill(g, k), this._initProps(k, g, q, b)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (ag[k._gsTweenID] = !0), c) }, aG.render = function (y, v, k) { var z; var b; var d; var w; var c = this._time; var j = this._duration; var p = this._rawPrevTime; if (y >= j) { this._totalTime = this._time = j, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (z = !0, b = 'onComplete'), j === 0 && (this._initted || !this.vars.lazy || k) && (this._startTime === this._timeline._duration && (y = 0), (y === 0 || p < 0 || p === aU) && p !== y && (k = !0, p > aU && (b = 'onReverseComplete')), this._rawPrevTime = w = !v || y || p === y ? y : aU) } else { if (y < 1e-7) { this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (c !== 0 || j === 0 && p > 0 && p !== aU) && (b = 'onReverseComplete', z = this._reversed), y < 0 && (this._active = !1, j === 0 && (this._initted || !this.vars.lazy || k) && (p >= 0 && (k = !0), this._rawPrevTime = w = !v || y || p === y ? y : aU)), this._initted || (k = !0) } else { if (this._totalTime = this._time = y, this._easeType) { var x = y / j; var g = this._easeType; var q = this._easePower; (g === 1 || g === 3 && x >= 0.5) && (x = 1 - x), g === 3 && (x *= 2), q === 1 ? x *= x : q === 2 ? x *= x * x : q === 3 ? x *= x * x * x : q === 4 && (x *= x * x * x * x), this.ratio = g === 1 ? 1 - x : g === 2 ? x : y / j < 0.5 ? x / 2 : 1 - x / 2 } else { this.ratio = this._ease.getRatio(y / j) } } } if (this._time !== c || k) { if (!this._initted) { if (this._init(), !this._initted || this._gc) { return } if (!k && this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration)) { return this._time = this._totalTime = c, this._rawPrevTime = p, au.push(this), this._lazy = [y, v], void 0 } this._time && !z ? this.ratio = this._ease.getRatio(this._time / j) : z && this._ease._calcEnd && (this.ratio = this._ease.getRatio(this._time === 0 ? 0 : 1)) } for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== c && y >= 0 && (this._active = !0), c === 0 && (this._startAt && (y >= 0 ? this._startAt.render(y, v, k) : b || (b = '_dummyGS')), this.vars.onStart && (this._time !== 0 || j === 0) && (v || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || Y))), d = this._firstPT; d;) { d.f ? d.t[d.p](d.c * this.ratio + d.s) : d.t[d.p] = d.c * this.ratio + d.s, d = d._next } this._onUpdate && (y < 0 && this._startAt && y !== -0.0001 && this._startAt.render(y, v, k), v || (this._time !== c || z) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || Y)), b && (!this._gc || k) && (y < 0 && this._startAt && !this._onUpdate && y !== -0.0001 && this._startAt.render(y, v, k), z && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !v && this.vars[b] && this.vars[b].apply(this.vars[b + 'Scope'] || this, this.vars[b + 'Params'] || Y), j === 0 && this._rawPrevTime === aU && w !== aU && (this._rawPrevTime = 0)) } }, aG._kill = function (v, k, g) { if (v === 'all' && (v = null), v == null && (k == null || k === this.target)) { return this._lazy = !1, this._enabled(!1, !1) }k = typeof k !== 'string' ? k || this._targets || this.target : aj.selector(k) || k; var w, b, d, m, c, f, j, p, q; if ((aO(k) || an(k)) && typeof k[0] !== 'number') { for (w = k.length; --w > -1;) { this._kill(v, k[w]) && (f = !0) } } else { if (this._targets) { for (w = this._targets.length; --w > -1;) { if (k === this._targets[w]) { c = this._propLookup[w] || {}, this._overwrittenProps = this._overwrittenProps || [], b = this._overwrittenProps[w] = v ? this._overwrittenProps[w] || {} : 'all'; break } } } else { if (k !== this.target) { return !1 }c = this._propLookup, b = this._overwrittenProps = v ? this._overwrittenProps || {} : 'all' } if (c) { if (j = v || c, p = v !== b && b !== 'all' && v !== c && (typeof v !== 'object' || !v._tempKill), g && (aj.onOverwrite || this.vars.onOverwrite)) { for (d in j) { c[d] && (q || (q = []), q.push(d)) } if (!ah(this, g, k, q)) { return !1 } } for (d in j) { (m = c[d]) && (m.pg && m.t._kill(j) && (f = !0), m.pg && m.t._overwriteProps.length !== 0 || (m._prev ? m._prev._next = m._next : m === this._firstPT && (this._firstPT = m._next), m._next && (m._next._prev = m._prev), m._next = m._prev = null), delete c[d]), p && (b[d] = 1) }!this._firstPT && this._initted && this._enabled(!1, !1) } } return f }, aG.invalidate = function () { return this._notifyPluginsOfEnabled && aj._onPluginEvent('_onDisable', this), this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], aa.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -aU, this.render(-this._delay)), this }, aG._enabled = function (b, d) { if (aF || aT.wake(), b && this._gc) { var a; var c = this._targets; if (c) { for (a = c.length; --a > -1;) { this._siblings[a] = at(c[a], this, !0) } } else { this._siblings = at(this.target, this, !0) } } return aa.prototype._enabled.call(this, b, d), this._notifyPluginsOfEnabled && this._firstPT ? aj._onPluginEvent(b ? '_onEnable' : '_onDisable', this) : !1 }, aj.to = function (b, c, a) { return new aj(b, c, a) }, aj.from = function (b, c, a) { return a.runBackwards = !0, a.immediateRender = a.immediateRender != 0, new aj(b, c, a) }, aj.fromTo = function (b, d, a, c) { return c.startAt = a, c.immediateRender = c.immediateRender != 0 && a.immediateRender != 0, new aj(b, d, c) }, aj.delayedCall = function (b, f, a, c, d) { return new aj(f, 0, { delay: b, onComplete: f, onCompleteParams: a, onCompleteScope: c, onReverseComplete: f, onReverseCompleteParams: a, onReverseCompleteScope: c, immediateRender: !1, useFrames: d, overwrite: 0 }) }, aj.set = function (a, b) { return new aj(a, 0, b) }, aj.getTweensOf = function (b, f) { if (b == null) { return [] }b = typeof b !== 'string' ? b : aj.selector(b) || b; var a, c, d, g; if ((aO(b) || an(b)) && typeof b[0] !== 'number') { for (a = b.length, c = []; --a > -1;) { c = c.concat(aj.getTweensOf(b[a], f)) } for (a = c.length; --a > -1;) { for (g = c[a], d = a; --d > -1;) { g === c[d] && c.splice(a, 1) } } } else { for (c = at(b).concat(), a = c.length; --a > -1;) { (c[a]._gc || f && !c[a].isActive()) && c.splice(a, 1) } } return c }, aj.killTweensOf = aj.killDelayedCallsTo = function (b, f, a) { typeof f === 'object' && (a = f, f = !1); for (var c = aj.getTweensOf(b, f), d = c.length; --d > -1;) { c[d]._kill(a, b) } }; var W = ay('plugins.TweenPlugin', function (a, b) { this._overwriteProps = (a || '').split(','), this._propName = this._overwriteProps[0], this._priority = b || 0, this._super = W.prototype }, !0); if (aG = W.prototype, W.version = '1.10.1', W.API = 2, aG._firstPT = null, aG._addTween = function (d, h, c, f, g, k) { var b, j; return f != null && (b = typeof f === 'number' || f.charAt(1) !== '=' ? Number(f) - c : parseInt(f.charAt(0) + '1', 10) * Number(f.substr(2))) ? (this._firstPT = j = { _next: this._firstPT, t: d, p: h, s: c, c: b, f: typeof d[h] === 'function', n: g || h, r: k }, j._next && (j._next._prev = j), j) : void 0 }, aG.setRatio = function (b) { for (var d, a = this._firstPT, c = 0.000001; a;) { d = a.c * b + a.s, a.r ? d = Math.round(d) : c > d && d > -c && (d = 0), a.f ? a.t[a.p](d) : a.t[a.p] = d, a = a._next } }, aG._kill = function (b) { var d; var a = this._overwriteProps; var c = this._firstPT; if (b[this._propName] != null) { this._overwriteProps = [] } else { for (d = a.length; --d > -1;) { b[a[d]] != null && a.splice(d, 1) } } for (;c;) { b[c.n] != null && (c._next && (c._next._prev = c._prev), c._prev ? (c._prev._next = c._next, c._prev = null) : this._firstPT === c && (this._firstPT = c._next)), c = c._next } return !1 }, aG._roundProps = function (b, c) { for (var a = this._firstPT; a;) { (b[this._propName] || a.n != null && b[a.n.split(this._propName + '_').join('')]) && (a.r = c), a = a._next } }, aj._onPluginEvent = function (d, h) { var c; var f; var g; var k; var b; var j = h._firstPT; if (d === '_onInitAllProps') { for (;j;) { for (b = j._next, f = g; f && f.pr > j.pr;) { f = f._next }(j._prev = f ? f._prev : k) ? j._prev._next = j : g = j, (j._next = f) ? f._prev = j : k = j, j = b }j = h._firstPT = g } for (;j;) { j.pg && typeof j.t[d] === 'function' && j.t[d]() && (c = !0), j = j._next } return c }, W.activate = function (a) { for (var b = a.length; --b > -1;) { a[b].API === W.API && (X[(new a[b]())._propName] = a[b]) } return !0 }, aQ.plugin = function (d) { if (!(d && d.propName && d.init && d.API)) { throw 'illegal plugin definition.' } var h; var c = d.propName; var f = d.priority || 0; var g = d.overwriteProps; var k = { init: '_onInitTween', set: 'setRatio', kill: '_kill', round: '_roundProps', initAll: '_onInitAllProps' }; var b = ay('plugins.' + c.charAt(0).toUpperCase() + c.substr(1) + 'Plugin', function () { W.call(this, c, f), this._overwriteProps = g || [] }, d.global === !0); var j = b.prototype = new W(c); j.constructor = b, b.API = d.API; for (h in k) { typeof d[h] === 'function' && (j[k[h]] = d[h]) } return b.version = d.version, W.activate([b]), b }, aB = aA._gsQueue) { for (aC = 0; aB.length > aC; aC++) { aB[aC]() } for (aG in aR) { aR[aG].func || aA.console.log('GSAP encountered missing dependency: com.greensock.' + aG) } }aF = !1 } })(typeof module !== 'undefined' && module.exports && typeof global !== 'undefined' ? global : this || window, 'TweenLite')
/*!
 * VERSION: 1.14.2
 * DATE: 2014-10-18
 * UPDATES AND DOCS AT: http://www.greensock.com
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope = typeof module !== 'undefined' && module.exports && typeof global !== 'undefined' ? global : this || window; (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () { _gsScope._gsDefine('TimelineLite', ['core.Animation', 'core.SimpleTimeline', 'TweenLite'], function (D, y, v) { var E = function (c) { y.call(this, c), this._labels = {}, this.autoRemoveChildren = this.vars.autoRemoveChildren === !0, this.smoothChildTiming = this.vars.smoothChildTiming === !0, this._sortChildren = !0, this._onUpdate = this.vars.onUpdate; var a; var f; var h = this.vars; for (f in h) { a = h[f], g(a) && a.join('').indexOf('{self}') !== -1 && (h[f] = this._swapSelfInParams(a)) }g(h.tweens) && this.add(h.tweens, 0, h.align, h.stagger) }; var b = 1e-10; var j = v._internals; var A = j.isSelector; var g = j.isArray; var w = j.lazyTweens; var q = j.lazyRender; var B = []; var C = _gsScope._gsDefine.globals; var z = function (c) { var f; var a = {}; for (f in c) { a[f] = c[f] } return a }; var d = function (c, l, a, f) { var h = c._timeline._totalTime; (l || !this._forcingPlayhead) && (c._timeline.pause(c._startTime), l && l.apply(f || c._timeline, a || B), this._forcingPlayhead && c._timeline.seek(h)) }; var x = function (c) { var h; var a = []; var f = c.length; for (h = 0; h !== f; a.push(c[h++])) {} return a }; var k = E.prototype = new y(); return E.version = '1.14.2', k.constructor = E, k.kill()._gc = k._forcingPlayhead = !1, k.to = function (a, h, c, f) { var i = c.repeat && C.TweenMax || v; return h ? this.add(new i(a, h, c), f) : this.set(a, c, f) }, k.from = function (a, h, c, f) { return this.add((c.repeat && C.TweenMax || v).from(a, h, c), f) }, k.fromTo = function (f, l, h, i, m) { var c = i.repeat && C.TweenMax || v; return l ? this.add(c.fromTo(f, l, h, i), m) : this.set(f, i, m) }, k.staggerTo = function (I, F, a, i, f, s, m, G) { var H; var c = new E({ onComplete: s, onCompleteParams: m, onCompleteScope: G, smoothChildTiming: this.smoothChildTiming }); for (typeof I === 'string' && (I = v.selector(I) || I), I = I || [], A(I) && (I = x(I)), i = i || 0, i < 0 && (I = x(I), I.reverse(), i *= -1), H = 0; I.length > H; H++) { a.startAt && (a.startAt = z(a.startAt)), c.to(I[H], F, z(a), H * i) } return this.add(c, f) }, k.staggerFrom = function (h, p, f, l, m, F, c, u) { return f.immediateRender = f.immediateRender != 0, f.runBackwards = !0, this.staggerTo(h, p, f, l, m, F, c, u) }, k.staggerFromTo = function (G, u, m, H, c, l, F, f, p) { return H.startAt = m, H.immediateRender = H.immediateRender != 0 && m.immediateRender != 0, this.staggerTo(G, u, H, c, l, F, f, p) }, k.call = function (a, h, c, f) { return this.add(v.delayedCall(0, a, h, c), f) }, k.set = function (a, f, c) { return c = this._parseTimeOrLabel(c, 0, !0), f.immediateRender == null && (f.immediateRender = c === this._time && !this._paused), this.add(new v(a, 0, f), c) }, E.exportRoot = function (f, i) { f = f || {}, f.smoothChildTiming == null && (f.smoothChildTiming = !0); var h; var m; var c = new E(f); var l = c._timeline; for (i == null && (i = !0), l._remove(c, !0), c._startTime = 0, c._rawPrevTime = c._time = c._totalTime = l._time, h = l._first; h;) { m = h._next, i && h instanceof v && h.target === h.vars.onComplete || c.add(h, h._startTime - h._delay), h = m } return l.add(c, 0), c }, k.add = function (i, o, H, t) { var s, I, J, G, m, F; if (typeof o !== 'number' && (o = this._parseTimeOrLabel(o, 0, !0, i)), !(i instanceof D)) { if (i instanceof Array || i && i.push && g(i)) { for (H = H || 'normal', t = t || 0, s = o, I = i.length, J = 0; I > J; J++) { g(G = i[J]) && (G = new E({ tweens: G })), this.add(G, s), typeof G !== 'string' && typeof G !== 'function' && (H === 'sequence' ? s = G._startTime + G.totalDuration() / G._timeScale : H === 'start' && (G._startTime -= G.delay())), s += t } return this._uncache(!0) } if (typeof i === 'string') { return this.addLabel(i, o) } if (typeof i !== 'function') { throw 'Cannot add ' + i + ' into the timeline; it is not a tween, timeline, function, or string.' }i = v.delayedCall(0, i) } if (y.prototype.add.call(this, i, o), (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration()) { for (m = this, F = m.rawTime() > i._startTime; m._timeline;) { F && m._timeline.smoothChildTiming ? m.totalTime(m._totalTime, !0) : m._gc && m._enabled(!0, !1), m = m._timeline } } return this }, k.remove = function (c) { if (c instanceof D) { return this._remove(c, !1) } if (c instanceof Array || c && c.push && g(c)) { for (var a = c.length; --a > -1;) { this.remove(c[a]) } return this } return typeof c === 'string' ? this.removeLabel(c) : this.kill(null, c) }, k._remove = function (c, a) { y.prototype._remove.call(this, c, a); var f = this._last; return f ? this._time > f._startTime + f._totalDuration / f._timeScale && (this._time = this.duration(), this._totalTime = this._totalDuration) : this._time = this._totalTime = this._duration = this._totalDuration = 0, this }, k.append = function (a, c) { return this.add(a, this._parseTimeOrLabel(null, c, !0, a)) }, k.insert = k.insertMultiple = function (c, h, a, f) { return this.add(c, h || 0, a, f) }, k.appendMultiple = function (c, h, a, f) { return this.add(c, this._parseTimeOrLabel(null, h, !0, c), a, f) }, k.addLabel = function (a, c) { return this._labels[a] = this._parseTimeOrLabel(c), this }, k.addPause = function (c, h, a, f) { return this.call(d, ['{self}', h, a, f], this, c) }, k.removeLabel = function (a) { return delete this._labels[a], this }, k.getLabelTime = function (a) { return this._labels[a] != null ? this._labels[a] : -1 }, k._parseTimeOrLabel = function (h, a, c, f) { var l; if (f instanceof D && f.timeline === this) { this.remove(f) } else { if (f && (f instanceof Array || f.push && g(f))) { for (l = f.length; --l > -1;) { f[l] instanceof D && f[l].timeline === this && this.remove(f[l]) } } } if (typeof a === 'string') { return this._parseTimeOrLabel(a, c && typeof h === 'number' && this._labels[a] == null ? h - this.duration() : 0, c) } if (a = a || 0, typeof h !== 'string' || !isNaN(h) && this._labels[h] == null) { h == null && (h = this.duration()) } else { if (l = h.indexOf('='), l === -1) { return this._labels[h] == null ? c ? this._labels[h] = this.duration() + a : a : this._labels[h] + a }a = parseInt(h.charAt(l - 1) + '1', 10) * Number(h.substr(l + 1)), h = l > 1 ? this._parseTimeOrLabel(h.substr(0, l - 1), 0, c) : this.duration() } return Number(h) + a }, k.seek = function (a, c) { return this.totalTime(typeof a === 'number' ? a : this._parseTimeOrLabel(a), c !== !1) }, k.stop = function () { return this.paused(!0) }, k.gotoAndPlay = function (a, c) { return this.play(a, c) }, k.gotoAndStop = function (a, c) { return this.pause(a, c) }, k.render = function (N, I, G) { this._gc && this._enabled(!0, !1); var O; var r; var L; var l; var M; var K = this._dirty ? this.totalDuration() : this._totalDuration; var h = this._time; var H = this._startTime; var F = this._timeScale; var J = this._paused; if (N >= K ? (this._totalTime = this._time = K, this._reversed || this._hasPausedChild() || (r = !0, l = 'onComplete', this._duration === 0 && (N === 0 || this._rawPrevTime < 0 || this._rawPrevTime === b) && this._rawPrevTime !== N && this._first && (M = !0, this._rawPrevTime > b && (l = 'onReverseComplete'))), this._rawPrevTime = this._duration || !I || N || this._rawPrevTime === N ? N : b, N = K + 0.0001) : N < 1e-7 ? (this._totalTime = this._time = 0, (h !== 0 || this._duration === 0 && this._rawPrevTime !== b && (this._rawPrevTime > 0 || N < 0 && this._rawPrevTime >= 0)) && (l = 'onReverseComplete', r = this._reversed), N < 0 ? (this._active = !1, this._rawPrevTime >= 0 && this._first && (M = !0), this._rawPrevTime = N) : (this._rawPrevTime = this._duration || !I || N || this._rawPrevTime === N ? N : b, N = 0, this._initted || (M = !0))) : this._totalTime = this._time = this._rawPrevTime = N, this._time !== h && this._first || G || M) { if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== h && N > 0 && (this._active = !0), h === 0 && this.vars.onStart && this._time !== 0 && (I || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || B)), this._time >= h) { for (O = this._first; O && (L = O._next, !this._paused || J);) { (O._active || O._startTime <= this._time && !O._paused && !O._gc) && (O._reversed ? O.render((O._dirty ? O.totalDuration() : O._totalDuration) - (N - O._startTime) * O._timeScale, I, G) : O.render((N - O._startTime) * O._timeScale, I, G)), O = L } } else { for (O = this._last; O && (L = O._prev, !this._paused || J);) { (O._active || h >= O._startTime && !O._paused && !O._gc) && (O._reversed ? O.render((O._dirty ? O.totalDuration() : O._totalDuration) - (N - O._startTime) * O._timeScale, I, G) : O.render((N - O._startTime) * O._timeScale, I, G)), O = L } } this._onUpdate && (I || (w.length && q(), this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || B))), l && (this._gc || (H === this._startTime || F !== this._timeScale) && (this._time === 0 || K >= this.totalDuration()) && (r && (w.length && q(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !I && this.vars[l] && this.vars[l].apply(this.vars[l + 'Scope'] || this, this.vars[l + 'Params'] || B))) } }, k._hasPausedChild = function () { for (var a = this._first; a;) { if (a._paused || a instanceof E && a._hasPausedChild()) { return !0 }a = a._next } return !1 }, k.getChildren = function (f, l, h, i) { i = i || -9999999999; for (var p = [], c = this._first, m = 0; c;) { i > c._startTime || (c instanceof v ? l !== !1 && (p[m++] = c) : (h !== !1 && (p[m++] = c), f !== !1 && (p = p.concat(c.getChildren(!0, l, h)), m = p.length))), c = c._next } return p }, k.getTweensOf = function (f, l) { var h; var i; var p = this._gc; var c = []; var m = 0; for (p && this._enabled(!0, !0), h = v.getTweensOf(f), i = h.length; --i > -1;) { (h[i].timeline === this || l && this._contains(h[i])) && (c[m++] = h[i]) } return p && this._enabled(!1, !0), c }, k.recent = function () { return this._recent }, k._contains = function (a) { for (var c = a.timeline; c;) { if (c === this) { return !0 }c = c.timeline } return !1 }, k.shiftChildren = function (c, l, a) { a = a || 0; for (var f, h = this._first, m = this._labels; h;) { h._startTime >= a && (h._startTime += c), h = h._next } if (l) { for (f in m) { m[f] >= a && (m[f] += c) } } return this._uncache(!0) }, k._kill = function (c, l) { if (!c && !l) { return this._enabled(!1, !1) } for (var a = l ? this.getTweensOf(l) : this.getChildren(!0, !0, !1), f = a.length, h = !1; --f > -1;) { a[f]._kill(c, l) && (h = !0) } return h }, k.clear = function (c) { var f = this.getChildren(!1, !0, !0); var a = f.length; for (this._time = this._totalTime = 0; --a > -1;) { f[a]._enabled(!1, !1) } return c !== !1 && (this._labels = {}), this._uncache(!0) }, k.invalidate = function () { for (var a = this._first; a;) { a.invalidate(), a = a._next } return D.prototype.invalidate.call(this) }, k._enabled = function (c, a) { if (c === this._gc) { for (var f = this._first; f;) { f._enabled(c, !0), f = f._next } } return y.prototype._enabled.call(this, c, a) }, k.totalTime = function () { this._forcingPlayhead = !0; var a = D.prototype.totalTime.apply(this, arguments); return this._forcingPlayhead = !1, a }, k.duration = function (a) { return arguments.length ? (this.duration() !== 0 && a !== 0 && this.timeScale(this._duration / a), this) : (this._dirty && this.totalDuration(), this._duration) }, k.totalDuration = function (c) { if (!arguments.length) { if (this._dirty) { for (var l, a, f = 0, h = this._last, m = 999999999999; h;) { l = h._prev, h._dirty && h.totalDuration(), h._startTime > m && this._sortChildren && !h._paused ? this.add(h, h._startTime - h._delay) : m = h._startTime, h._startTime < 0 && !h._paused && (f -= h._startTime, this._timeline.smoothChildTiming && (this._startTime += h._startTime / this._timeScale), this.shiftChildren(-h._startTime, !1, -9999999999), m = 0), a = h._startTime + h._totalDuration / h._timeScale, a > f && (f = a), h = l } this._duration = this._totalDuration = f, this._dirty = !1 } return this._totalDuration } return this.totalDuration() !== 0 && c !== 0 && this.timeScale(this._totalDuration / c), this }, k.usesFrames = function () { for (var a = this._timeline; a._timeline;) { a = a._timeline } return a === D._rootFramesTimeline }, k.rawTime = function () { return this._paused ? this._totalTime : (this._timeline.rawTime() - this._startTime) * this._timeScale }, E }, !0) }), _gsScope._gsDefine && _gsScope._gsQueue.pop()(), (function (a) { var b = function () { return (_gsScope.GreenSockGlobals || _gsScope)[a] }; typeof define === 'function' && define.amd ? define(['TweenLite'], b) : typeof module !== 'undefined' && module.exports && (require('./TweenLite.js'), module.exports = b()) }('TimelineLite'))
/*!
 * VERSION: beta 1.9.4
 * DATE: 2014-07-17
 * UPDATES AND DOCS AT: http://www.greensock.com
 ...
 * @author: Jack Doyle, jack@greensock.com
 **/
var _gsScope = typeof module !== 'undefined' && module.exports && typeof global !== 'undefined' ? global : this || window; (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () { _gsScope._gsDefine('easing.Back', ['easing.Ease'], function (F) { var z; var w; var G; var b = _gsScope.GreenSockGlobals || _gsScope; var k = b.com.greensock; var C = 2 * Math.PI; var j = Math.PI / 2; var x = k._class; var v = function (f, a) { var c = x('easing.' + f, function () {}, !0); var d = c.prototype = new F(); return d.constructor = c, d.getRatio = a, c }; var D = F.register || function () {}; var E = function (c, h, a, d) { var f = x('easing.' + c, { easeOut: new h(), easeIn: new a(), easeInOut: new d() }, !0); return D(f, c), f }; var B = function (c, d, a) { this.t = c, this.v = d, a && (this.next = a, a.prev = this, this.c = a.v - d, this.gap = a.t - c) }; var g = function (f, a) { var c = x('easing.' + f, function (h) { this._p1 = h || h === 0 ? h : 1.70158, this._p2 = 1.525 * this._p1 }, !0); var d = c.prototype = new F(); return d.constructor = c, d.getRatio = a, d.config = function (h) { return new c(h) }, c }; var y = E('Back', g('BackOut', function (a) { return (a -= 1) * a * ((this._p1 + 1) * a + this._p1) + 1 }), g('BackIn', function (a) { return a * a * ((this._p1 + 1) * a - this._p1) }), g('BackInOut', function (a) { return (a *= 2) < 1 ? 0.5 * a * a * ((this._p2 + 1) * a - this._p2) : 0.5 * ((a -= 2) * a * ((this._p2 + 1) * a + this._p2) + 2) })); var q = x('easing.SlowMo', function (c, d, a) { d = d || d === 0 ? d : 0.7, c == null ? c = 0.7 : c > 1 && (c = 1), this._p = c !== 1 ? d : 0, this._p1 = (1 - c) / 2, this._p2 = c, this._p3 = this._p1 + this._p2, this._calcEnd = a === !0 }, !0); var A = q.prototype = new F(); return A.constructor = q, A.getRatio = function (a) { var c = a + (0.5 - a) * this._p; return this._p1 > a ? this._calcEnd ? 1 - (a = 1 - a / this._p1) * a : c - (a = 1 - a / this._p1) * a * a * a * c : a > this._p3 ? this._calcEnd ? 1 - (a = (a - this._p3) / this._p1) * a : c + (a - c) * (a = (a - this._p3) / this._p1) * a * a * a : this._calcEnd ? 1 : c }, q.ease = new q(0.7, 0.7), A.config = q.config = function (c, d, a) { return new q(c, d, a) }, z = x('easing.SteppedEase', function (a) { a = a || 1, this._p1 = 1 / a, this._p2 = a + 1 }, !0), A = z.prototype = new F(), A.constructor = z, A.getRatio = function (a) { return a < 0 ? a = 0 : a >= 1 && (a = 0.999999999), (this._p2 * a >> 0) * this._p1 }, A.config = z.config = function (a) { return new z(a) }, w = x('easing.RoughEase', function (P) { P = P || {}; for (var L, U, c, I, R, H, M = P.taper || 'none', K = [], S = 0, T = 0 | (P.points || 20), t = T, O = P.randomize !== !1, J = P.clamp === !0, Q = P.template instanceof F ? P.template : null, N = typeof P.strength === 'number' ? 0.4 * P.strength : 0.4; --t > -1;) { L = O ? Math.random() : 1 / T * t, U = Q ? Q.getRatio(L) : L, M === 'none' ? c = N : M === 'out' ? (I = 1 - L, c = I * I * N) : M === 'in' ? c = L * L * N : L < 0.5 ? (I = 2 * L, c = 0.5 * I * I * N) : (I = 2 * (1 - L), c = 0.5 * I * I * N), O ? U += Math.random() * c - 0.5 * c : t % 2 ? U += 0.5 * c : U -= 0.5 * c, J && (U > 1 ? U = 1 : U < 0 && (U = 0)), K[S++] = { x: L, y: U } } for (K.sort(function (a, d) { return a.x - d.x }), H = new B(1, 1, null), t = T; --t > -1;) { R = K[t], H = new B(R.x, R.y, H) } this._prev = new B(0, 0, H.t !== 0 ? H : H.next) }, !0), A = w.prototype = new F(), A.constructor = w, A.getRatio = function (a) { var c = this._prev; if (a > c.t) { for (;c.next && a >= c.t;) { c = c.next }c = c.prev } else { for (;c.prev && c.t >= a;) { c = c.prev } } return this._prev = c, c.v + (a - c.t) / c.gap * c.c }, A.config = function (a) { return new w(a) }, w.ease = new w(), E('Bounce', v('BounceOut', function (a) { return 1 / 2.75 > a ? 7.5625 * a * a : 2 / 2.75 > a ? 7.5625 * (a -= 1.5 / 2.75) * a + 0.75 : 2.5 / 2.75 > a ? 7.5625 * (a -= 2.25 / 2.75) * a + 0.9375 : 7.5625 * (a -= 2.625 / 2.75) * a + 0.984375 }), v('BounceIn', function (a) { return 1 / 2.75 > (a = 1 - a) ? 1 - 7.5625 * a * a : 2 / 2.75 > a ? 1 - (7.5625 * (a -= 1.5 / 2.75) * a + 0.75) : 2.5 / 2.75 > a ? 1 - (7.5625 * (a -= 2.25 / 2.75) * a + 0.9375) : 1 - (7.5625 * (a -= 2.625 / 2.75) * a + 0.984375) }), v('BounceInOut', function (a) { var c = a < 0.5; return a = c ? 1 - 2 * a : 2 * a - 1, a = 1 / 2.75 > a ? 7.5625 * a * a : 2 / 2.75 > a ? 7.5625 * (a -= 1.5 / 2.75) * a + 0.75 : 2.5 / 2.75 > a ? 7.5625 * (a -= 2.25 / 2.75) * a + 0.9375 : 7.5625 * (a -= 2.625 / 2.75) * a + 0.984375, c ? 0.5 * (1 - a) : 0.5 * a + 0.5 })), E('Circ', v('CircOut', function (a) { return Math.sqrt(1 - (a -= 1) * a) }), v('CircIn', function (a) { return -(Math.sqrt(1 - a * a) - 1) }), v('CircInOut', function (a) { return (a *= 2) < 1 ? -0.5 * (Math.sqrt(1 - a * a) - 1) : 0.5 * (Math.sqrt(1 - (a -= 2) * a) + 1) })), G = function (f, a, c) { var d = x('easing.' + f, function (i, l) { this._p1 = i || 1, this._p2 = l || c, this._p3 = this._p2 / C * (Math.asin(1 / this._p1) || 0) }, !0); var h = d.prototype = new F(); return h.constructor = d, h.getRatio = a, h.config = function (i, l) { return new d(i, l) }, d }, E('Elastic', G('ElasticOut', function (a) { return this._p1 * Math.pow(2, -10 * a) * Math.sin((a - this._p3) * C / this._p2) + 1 }, 0.3), G('ElasticIn', function (a) { return -(this._p1 * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - this._p3) * C / this._p2)) }, 0.3), G('ElasticInOut', function (a) { return (a *= 2) < 1 ? -0.5 * this._p1 * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - this._p3) * C / this._p2) : 0.5 * this._p1 * Math.pow(2, -10 * (a -= 1)) * Math.sin((a - this._p3) * C / this._p2) + 1 }, 0.45)), E('Expo', v('ExpoOut', function (a) { return 1 - Math.pow(2, -10 * a) }), v('ExpoIn', function (a) { return Math.pow(2, 10 * (a - 1)) - 0.001 }), v('ExpoInOut', function (a) { return (a *= 2) < 1 ? 0.5 * Math.pow(2, 10 * (a - 1)) : 0.5 * (2 - Math.pow(2, -10 * (a - 1))) })), E('Sine', v('SineOut', function (a) { return Math.sin(a * j) }), v('SineIn', function (a) { return -Math.cos(a * j) + 1 }), v('SineInOut', function (a) { return -0.5 * (Math.cos(Math.PI * a) - 1) })), x('easing.EaseLookup', { find: function (a) { return F.map[a] } }, !0), D(b.SlowMo, 'SlowMo', 'ease,'), D(w, 'RoughEase', 'ease,'), D(z, 'SteppedEase', 'ease,'), y }, !0) }), _gsScope._gsDefine && _gsScope._gsQueue.pop()()
/*!
 * VERSION: 1.14.2
 * DATE: 2014-10-28
 * UPDATES AND DOCS AT: http://www.greensock.com
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope = typeof module !== 'undefined' && module.exports && typeof global !== 'undefined' ? global : this || window; (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () { _gsScope._gsDefine('plugins.CSSPlugin', ['plugins.TweenPlugin', 'TweenLite'], function (au, aN) { var aI; var aw; var av; var aB; var aT = function () { au.call(this, 'css'), this._overwriteProps.length = 0, this.setRatio = aT.prototype.setRatio }; var aA = {}; var aF = aT.prototype = new au('css'); aF.constructor = aT, aT.version = '1.14.2', aT.API = 2, aT.defaultTransformPerspective = 0, aT.defaultSkewType = 'compensated', aF = 'px', aT.suffixMap = { top: aF, right: aF, bottom: aF, left: aF, width: aF, height: aF, fontSize: aF, padding: aF, margin: aF, perspective: aF, lineHeight: '' }; var aJ; var at; var aM; var az; var aU; var aP; var aO = /(?:\d|\-\d|\.\d|\-\.\d)+/g; var aC = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g; var aL = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi; var ar = /(?![+-]?\d*\.?\d+|e[+-]\d+)[^0-9]/g; var ao = /(?:\d|\-|\+|=|#|\.)*/g; var ap = /opacity *= *([^)]*)/i; var a1 = /opacity:([^;]*)/i; var aq = /alpha\(opacity *=.+?\)/i; var aS = /^(rgb|hsl)/; var a6 = /([A-Z])/g; var a3 = /-([a-z])/gi; var a4 = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi; var bq = function (a, b) { return b.toUpperCase() }; var aG = /(?:Left|Right|Width)/i; var a7 = /(M11|M12|M21|M22)=[\d\-\.e]+/gi; var bs = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i; var bn = /,(?=[^\)]*(?:\(|$))/gi; var bb = Math.PI / 180; var bc = 180 / Math.PI; var a9 = {}; var an = document; var aX = an.createElement('div'); var bg = an.createElement('img'); var bm = aT._internals = { _specialProps: aA }; var bl = navigator.userAgent; var aW = (function () { var b; var c = bl.indexOf('Android'); var a = an.createElement('div'); return aM = bl.indexOf('Safari') !== -1 && bl.indexOf('Chrome') === -1 && (c === -1 || Number(bl.substr(c + 8, 1)) > 3), aU = aM && Number(bl.substr(bl.indexOf('Version/') + 8, 1)) < 6, az = bl.indexOf('Firefox') !== -1, (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(bl) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(bl)) && (aP = parseFloat(RegExp.$1)), a.innerHTML = "<a style='top:1px;opacity:.55;'>a</a>", b = a.getElementsByTagName('a')[0], b ? /^0.55/.test(b.style.opacity) : !1 }()); var br = function (a) { return ap.test(typeof a === 'string' ? a : (a.currentStyle ? a.currentStyle.filter : a.style.filter) || '') ? parseFloat(RegExp.$1) / 100 : 1 }; var a0 = function (a) { window.console && console.log(a) }; var aH = ''; var aY = ''; var aZ = function (b, f) { f = f || aX; var a; var d; var c = f.style; if (void 0 !== c[b]) { return b } for (b = b.charAt(0).toUpperCase() + b.substr(1), a = ['O', 'Moz', 'ms', 'Ms', 'Webkit'], d = 5; --d > -1 && void 0 === c[a[d] + b];) {} return d >= 0 ? (aY = d === 3 ? 'ms' : a[d], aH = '-' + aY.toLowerCase() + '-', aY + b) : null }; var ay = an.defaultView ? an.defaultView.getComputedStyle : function () {}; var bj = aT.getStyle = function (b, f, a, d, c) { var g; return aW || f !== 'opacity' ? (!d && b.style[f] ? g = b.style[f] : (a = a || ay(b)) ? g = a[f] || a.getPropertyValue(f) || a.getPropertyValue(f.replace(a6, '-$1').toLowerCase()) : b.currentStyle && (g = b.currentStyle[f]), c == null || g && g !== 'none' && g !== 'auto' && g !== 'auto auto' ? g : c) : br(b) }; var bk = bm.convertToPixels = function (w, j, a, x, d) { if (x === 'px' || !x) { return a } if (x === 'auto' || !a) { return 0 } var c; var g; var k; var v = aG.test(j); var m = w; var b = aX.style; var q = a < 0; if (q && (a = -a), x === '%' && j.indexOf('border') !== -1) { c = a / 100 * (v ? w.clientWidth : w.clientHeight) } else { if (b.cssText = 'border:0 solid red;position:' + bj(w, 'position') + ';line-height:0;', x !== '%' && m.appendChild) { b[v ? 'borderLeftWidth' : 'borderTopWidth'] = a + x } else { if (m = w.parentNode || an.body, g = m._gsCache, k = aN.ticker.frame, g && v && g.time === k) { return g.width * a / 100 }b[v ? 'width' : 'height'] = a + x }m.appendChild(aX), c = parseFloat(aX[v ? 'offsetWidth' : 'offsetHeight']), m.removeChild(aX), v && x === '%' && aT.cacheWidths !== !1 && (g = m._gsCache = m._gsCache || {}, g.time = k, g.width = 100 * (c / a)), c !== 0 || d || (c = bk(w, j, a, x, !0)) } return q ? -c : c }; var a5 = bm.calculateOffset = function (b, f, a) { if (bj(b, 'position', a) !== 'absolute') { return 0 } var d = f === 'left' ? 'Left' : 'Top'; var c = bj(b, 'margin' + d, a); return b['offset' + d] - (bk(b, f, parseFloat(c), c.replace(ao, '')) || 0) }; var aV = function (b, f) { var a; var d; var c = {}; if (f = f || ay(b, null)) { if (a = f.length) { for (;--a > -1;) { c[f[a].replace(a3, bq)] = f.getPropertyValue(f[a]) } } else { for (a in f) { c[a] = f[a] } } } else { if (f = b.currentStyle || b.style) { for (a in f) { typeof a === 'string' && void 0 === c[a] && (c[a.replace(a3, bq)] = f[a]) } } } return aW || (c.opacity = br(b)), d = bD(b, f, !1), c.rotation = d.rotation, c.skewX = d.skewX, c.scaleX = d.scaleX, c.scaleY = d.scaleY, c.x = d.x, c.y = d.y, a2 && (c.z = d.z, c.rotationX = d.rotationX, c.rotationY = d.rotationY, c.scaleZ = d.scaleZ), c.filters && delete c.filters, c }; var bz = function (p, k, g, b, q) { var d; var m; var c; var f = {}; var j = p.style; for (m in g) { m !== 'cssText' && m !== 'length' && isNaN(m) && (k[m] !== (d = g[m]) || q && q[m]) && m.indexOf('Origin') === -1 && (typeof d === 'number' || typeof d === 'string') && (f[m] = d !== 'auto' || m !== 'left' && m !== 'top' ? d !== '' && d !== 'auto' && d !== 'none' || typeof k[m] !== 'string' || k[m].replace(ar, '') === '' ? d : 0 : a5(p, m), void 0 !== j[m] && (c = new bC(j, m, j[m], c))) } if (b) { for (m in b) { m !== 'className' && (f[m] = b[m]) } } return { difs: f, firstMPT: c } }; var bd = { width: ['Left', 'Right'], height: ['Top', 'Bottom'] }; var bf = ['marginLeft', 'marginRight', 'marginTop', 'marginBottom']; var bo = function (b, f, a) { var d = parseFloat(f === 'width' ? b.offsetWidth : b.offsetHeight); var c = bd[f]; var g = c.length; for (a = a || ay(b, null); --g > -1;) { d -= parseFloat(bj(b, 'padding' + c[g], a, !0)) || 0, d -= parseFloat(bj(b, 'border' + c[g] + 'Width', a, !0)) || 0 } return d }; var ab = function (b, f) { (b == null || b === '' || b === 'auto' || b === 'auto auto') && (b = '0 0'); var a = b.split(' '); var d = b.indexOf('left') !== -1 ? '0%' : b.indexOf('right') !== -1 ? '100%' : a[0]; var c = b.indexOf('top') !== -1 ? '0%' : b.indexOf('bottom') !== -1 ? '100%' : a[1]; return c == null ? c = '0' : c === 'center' && (c = '50%'), (d === 'center' || isNaN(parseFloat(d)) && (d + '').indexOf('=') === -1) && (d = '50%'), f && (f.oxp = d.indexOf('%') !== -1, f.oyp = c.indexOf('%') !== -1, f.oxr = d.charAt(1) === '=', f.oyr = c.charAt(1) === '=', f.ox = parseFloat(d.replace(ar, '')), f.oy = parseFloat(c.replace(ar, ''))), d + ' ' + c + (a.length > 2 ? ' ' + a[2] : '') }; var aD = function (a, b) { return typeof a === 'string' && a.charAt(1) === '=' ? parseInt(a.charAt(0) + '1', 10) * parseFloat(a.substr(2)) : parseFloat(a) - parseFloat(b) }; var bF = function (a, b) { return a == null ? b : typeof a === 'string' && a.charAt(1) === '=' ? parseInt(a.charAt(0) + '1', 10) * parseFloat(a.substr(2)) + b : parseFloat(a) }; var bx = function (k, h, g, b) { var m; var d; var j; var c; var f = 0.000001; return k == null ? c = h : typeof k === 'number' ? c = k : (m = 360, d = k.split('_'), j = Number(d[0].replace(ar, '')) * (k.indexOf('rad') === -1 ? 1 : bc) - (k.charAt(1) === '=' ? 0 : h), d.length && (b && (b[g] = h + j), k.indexOf('short') !== -1 && (j %= m, j !== j % (m / 2) && (j = j < 0 ? j + m : j - m)), k.indexOf('_cw') !== -1 && j < 0 ? j = (j + 9999999999 * m) % m - (0 | j / m) * m : k.indexOf('ccw') !== -1 && j > 0 && (j = (j - 9999999999 * m) % m - (0 | j / m) * m)), c = h + j), f > c && c > -f && (c = 0), c }; var bh = { aqua: [0, 255, 255], lime: [0, 255, 0], silver: [192, 192, 192], black: [0, 0, 0], maroon: [128, 0, 0], teal: [0, 128, 128], blue: [0, 0, 255], navy: [0, 0, 128], white: [255, 255, 255], fuchsia: [255, 0, 255], olive: [128, 128, 0], yellow: [255, 255, 0], orange: [255, 165, 0], gray: [128, 128, 128], purple: [128, 0, 128], green: [0, 128, 0], red: [255, 0, 0], pink: [255, 192, 203], cyan: [0, 255, 255], transparent: [255, 255, 255, 0] }; var bu = function (b, c, a) { return b = b < 0 ? b + 1 : b > 1 ? b - 1 : b, 0 | 255 * (6 * b < 1 ? c + 6 * (a - c) * b : b < 0.5 ? a : 3 * b < 2 ? c + 6 * (a - c) * (2 / 3 - b) : c) + 0.5 }; var aK = aT.parseColor = function (d) { var h, c, g, f, j, b; return d && d !== '' ? typeof d === 'number' ? [d >> 16, 255 & d >> 8, 255 & d] : (d.charAt(d.length - 1) === ',' && (d = d.substr(0, d.length - 1)), bh[d] ? bh[d] : d.charAt(0) === '#' ? (d.length === 4 && (h = d.charAt(1), c = d.charAt(2), g = d.charAt(3), d = '#' + h + h + c + c + g + g), d = parseInt(d.substr(1), 16), [d >> 16, 255 & d >> 8, 255 & d]) : d.substr(0, 3) === 'hsl' ? (d = d.match(aO), f = Number(d[0]) % 360 / 360, j = Number(d[1]) / 100, b = Number(d[2]) / 100, c = b <= 0.5 ? b * (j + 1) : b + j - b * j, h = 2 * b - c, d.length > 3 && (d[3] = Number(d[3])), d[0] = bu(f + 1 / 3, h, c), d[1] = bu(f, h, c), d[2] = bu(f - 1 / 3, h, c), d) : (d = d.match(aO) || bh.transparent, d[0] = Number(d[0]), d[1] = Number(d[1]), d[2] = Number(d[2]), d.length > 3 && (d[3] = Number(d[3])), d)) : bh.black }; var bE = '(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#.+?\\b'; for (aF in bh) { bE += '|' + aF + '\\b' }bE = RegExp(bE + ')', 'gi'); var a8 = function (w, p, j, b) { if (w == null) { return function (a) { return a } } var x; var d = p ? (w.match(bE) || [''])[0] : ''; var q = w.split(d).join('').match(aL) || []; var c = w.substr(0, w.indexOf(q[0])); var g = w.charAt(w.length - 1) === ')' ? ')' : ''; var k = w.indexOf(' ') !== -1 ? ' ' : ','; var v = q.length; var m = v > 0 ? q[0].replace(aO, '') : ''; return v ? x = p ? function (f) { var i, h, a, l; if (typeof f === 'number') { f += m } else { if (b && bn.test(f)) { for (l = f.replace(bn, '|').split('|'), a = 0; l.length > a; a++) { l[a] = x(l[a]) } return l.join(',') } } if (i = (f.match(bE) || [d])[0], h = f.split(i).join('').match(aL) || [], a = h.length, v > a--) { for (;v > ++a;) { h[a] = j ? h[0 | (a - 1) / 2] : q[a] } } return c + h.join(k) + k + i + g + (f.indexOf('inset') !== -1 ? ' inset' : '') } : function (a) { var h, i, f; if (typeof a === 'number') { a += m } else { if (b && bn.test(a)) { for (i = a.replace(bn, '|').split('|'), f = 0; i.length > f; f++) { i[f] = x(i[f]) } return i.join(',') } } if (h = a.match(aL) || [], f = h.length, v > f--) { for (;v > ++f;) { h[f] = j ? h[0 | (f - 1) / 2] : q[f] } } return c + h.join(k) + g } : function (a) { return a } }; var aQ = function (a) { return a = a.split(','), function (k, g, b, p, d, m, c) { var f; var j = (g + '').split(' '); for (c = {}, f = 0; f < 4; f++) { c[a[f]] = j[f] = j[f] || j[(f - 1) / 2 >> 0] } return p.parse(k, c, d, m) } }; var bC = (bm._setPluginRatio = function (k) { this.plugin.setRatio(k); for (var h, g, b, m, d = this.data, j = d.proxy, c = d.firstMPT, f = 0.000001; c;) { h = j[c.v], c.r ? h = Math.round(h) : f > h && h > -f && (h = 0), c.t[c.p] = h, c = c._next } if (d.autoRotate && (d.autoRotate.rotation = j.rotation), k === 1) { for (c = d.firstMPT; c;) { if (g = c.t, g.type) { if (g.type === 1) { for (m = g.xs0 + g.s + g.xs1, b = 1; g.l > b; b++) { m += g['xn' + b] + g['xs' + (b + 1)] }g.e = m } } else { g.e = g.s + g.xs0 }c = c._next } } }, function (b, f, a, d, c) { this.t = b, this.p = f, this.v = a, this.r = c, d && (d._prev = this, this._next = d) }); var al = (bm._parseToProxy = function (D, x, q, b, E, k) { var A; var j; var m; var v; var C; var w = b; var g = {}; var B = {}; var z = q._transform; var y = a9; for (q._transform = null, a9 = x, b = C = q.parse(D, x, b, E), a9 = y, k && (q._transform = z, w && (w._prev = null, w._prev && (w._prev._next = null))); b && b !== w;) { if (b.type <= 1 && (j = b.p, B[j] = b.s + b.c, g[j] = b.s, k || (v = new bC(b, 's', j, v, b.r), b.c = 0), b.type === 1)) { for (A = b.l; --A > 0;) { m = 'xn' + A, j = b.p + '_' + m, B[j] = b.data[m], g[j] = b[m], k || (v = new bC(b, m, j, v, b.rxp[m])) } }b = b._next } return { proxy: g, end: B, firstMPT: v, pt: C } }, bm.CSSPropTween = function (q, k, b, v, m, d, g, i, n, j, c) { this.t = q, this.p = k, this.s = b, this.c = v, this.n = g || k, q instanceof al || aB.push(this.n), this.r = i, this.type = d || 0, n && (this.pr = n, aI = !0), this.b = void 0 === j ? b : j, this.e = void 0 === c ? b + v : c, m && (this._next = m, m._prev = this) }); var aa = aT.parseComplex = function (E, V, N, H, F, K, X, J, L, D) { N = N || K || '', X = new al(E, V, 0, 0, X, D ? 2 : 1, null, !1, J, N, H), H += ''; var U; var I; var Y; var W; var Q; var B; var q; var z; var b; var A; var j; var d; var h = N.split(', ').join(',').split(' '); var G = H.split(', ').join(',').split(' '); var M = h.length; var m = aJ !== !1; for ((H.indexOf(',') !== -1 || N.indexOf(',') !== -1) && (h = h.join(' ').replace(bn, ', ').split(' '), G = G.join(' ').replace(bn, ', ').split(' '), M = h.length), M !== G.length && (h = (K || '').split(' '), M = h.length), X.plugin = L, X.setRatio = D, U = 0; M > U; U++) { if (W = h[U], Q = G[U], z = parseFloat(W), z || z === 0) { X.appendXtra('', z, aD(Q, z), Q.replace(aC, ''), m && Q.indexOf('px') !== -1, !0) } else { if (F && (W.charAt(0) === '#' || bh[W] || aS.test(W))) { d = Q.charAt(Q.length - 1) === ',' ? '),' : ')', W = aK(W), Q = aK(Q), b = W.length + Q.length > 6, b && !aW && Q[3] === 0 ? (X['xs' + X.l] += X.l ? ' transparent' : 'transparent', X.e = X.e.split(G[U]).join('transparent')) : (aW || (b = !1), X.appendXtra(b ? 'rgba(' : 'rgb(', W[0], Q[0] - W[0], ',', !0, !0).appendXtra('', W[1], Q[1] - W[1], ',', !0).appendXtra('', W[2], Q[2] - W[2], b ? ',' : d, !0), b && (W = W.length < 4 ? 1 : W[3], X.appendXtra('', W, (Q.length < 4 ? 1 : Q[3]) - W, d, !1))) } else { if (B = W.match(aO)) { if (q = Q.match(aC), !q || q.length !== B.length) { return X } for (Y = 0, I = 0; B.length > I; I++) { j = B[I], A = W.indexOf(j, Y), X.appendXtra(W.substr(Y, A - Y), Number(j), aD(q[I], j), '', m && W.substr(A + j.length, 2) === 'px', I === 0), Y = A + j.length }X['xs' + X.l] += W.substr(Y) } else { X['xs' + X.l] += X.l ? ' ' + W : W } } } } if (H.indexOf('=') !== -1 && X.data) { for (d = X.xs0 + X.data.s, U = 1; X.l > U; U++) { d += X['xs' + U] + X.data['xn' + U] }X.e = d + X['xs' + U] } return X.l || (X.type = -1, X.xs0 = X.e), X.xfirst || X }; var ax = 9; for (aF = al.prototype, aF.l = aF.pr = 0; --ax > 0;) { aF['xn' + ax] = 0, aF['xs' + ax] = '' }aF.xs0 = '', aF._next = aF._prev = aF.xfirst = aF.data = aF.plugin = aF.setRatio = aF.rxp = null, aF.appendXtra = function (d, h, c, g, f, k) { var b = this; var j = b.l; return b['xs' + j] += k && j ? ' ' + d : d || '', c || j === 0 || b.plugin ? (b.l++, b.type = b.setRatio ? 2 : 1, b['xs' + b.l] = g || '', j > 0 ? (b.data['xn' + j] = h + c, b.rxp['xn' + j] = f, b['xn' + j] = h, b.plugin || (b.xfirst = new al(b, 'xn' + j, h, c, b.xfirst || b, 0, b.n, f, b.pr), b.xfirst.xs0 = 0), b) : (b.data = { s: h + c }, b.rxp = {}, b.s = h, b.c = c, b.r = f, b)) : (b['xs' + j] += h + (g || ''), b) }; var aj = function (a, b) { b = b || {}, this.p = b.prefix ? aZ(a) || a : a, aA[a] = aA[this.p] = this, this.format = b.formatter || a8(b.defaultValue, b.color, b.collapsible, b.multi), b.parser && (this.parse = b.parser), this.clrs = b.color, this.multi = b.multi, this.keyword = b.keyword, this.dflt = b.defaultValue, this.pr = b.priority || 0 }; var bw = bm._registerComplexSpecialProp = function (d, h, c) { typeof h !== 'object' && (h = { parser: c }); var g; var f; var j = d.split(','); var b = h.defaultValue; for (c = c || [b], g = 0; j.length > g; g++) { h.prefix = g === 0 && h.prefix, h.defaultValue = c[g] || b, f = new aj(j[g], h) } }; var bv = function (a) { if (!aA[a]) { var b = a.charAt(0).toUpperCase() + a.substr(1) + 'Plugin'; bw(a, { parser: function (g, f, m, k, o, d, c) { var j = (_gsScope.GreenSockGlobals || _gsScope).com.greensock.plugins[b]; return j ? (j._cssRegister(), aA[m].parse(g, f, m, k, o, d, c)) : (a0('Error: ' + b + ' js file not loaded.'), o) } }) } }; aF = aj.prototype, aF.parseComplex = function (y, v, k, b, z, g) { var w; var d; var j; var m; var x; var q; var c = this.keyword; if (this.multi && (bn.test(k) || bn.test(v) ? (d = v.replace(bn, '|').split('|'), j = k.replace(bn, '|').split('|')) : c && (d = [v], j = [k])), j) { for (m = j.length > d.length ? j.length : d.length, w = 0; m > w; w++) { v = d[w] = d[w] || this.dflt, k = j[w] = j[w] || this.dflt, c && (x = v.indexOf(c), q = k.indexOf(c), x !== q && (k = q === -1 ? j : d, k[w] += ' ' + c)) }v = d.join(', '), k = j.join(', ') } return aa(y, this.p, v, k, this.clrs, this.dflt, b, this.pr, z, g) }, aF.parse = function (d, g, c, f, h, b) { return this.parseComplex(d.style, this.format(bj(d, this.p, av, !1, this.dflt)), this.format(g), h, b) }, aT.registerSpecialProp = function (b, c, a) { bw(b, { parser: function (g, i, h, k, f, j) { var d = new al(g, h, 0, 0, f, 2, h, !1, a); return d.plugin = j, d.setRatio = c(g, i, k._tween, h), d }, priority: a }) }; var am; var bA = 'scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent'.split(','); var bH = aZ('transform'); var bB = aH + 'transform'; var ag = aZ('transformOrigin'); var a2 = aZ('perspective') !== null; var aR = bm.Transform = function () { this.skewY = 0 }; var bI = window.SVGElement; var ah = function (b, f, a) { var d; var c = an.createElementNS('http://www.w3.org/2000/svg', b); var g = /([a-z])([A-Z])/g; for (d in a) { c.setAttributeNS(null, d.replace(g, '$1-$2').toLowerCase(), a[d]) } return f.appendChild(c), c }; var ba = document.documentElement; var ac = (function () { var b; var d; var a; var c = aP || /Android/i.test(bl) && !window.chrome; return an.createElementNS && !c && (b = ah('svg', ba), d = ah('rect', b, { width: 100, height: 50, x: 100 }), a = d.getBoundingClientRect().left, d.style[ag] = '50% 50%', d.style[bH] = 'scale(0.5,0.5)', c = a === d.getBoundingClientRect().left, ba.removeChild(b)), c }()); var bp = function (b, d, a) { var c = b.getBBox(); d = ab(d).split(' '), a.xOrigin = (d[0].indexOf('%') !== -1 ? parseFloat(d[0]) / 100 * c.width : parseFloat(d[0])) + c.x, a.yOrigin = (d[1].indexOf('%') !== -1 ? parseFloat(d[1]) / 100 * c.height : parseFloat(d[1])) + c.y }; var bD = bm.getTransform = function (b9, cn, cj, ca) { if (b9._gsTransform && cj && !ca) { return b9._gsTransform } var ce; var cd; var cg; var ck; var b8; var cm; var cc; var cs; var cp; var co; var cf; var cl; var b7; var b3 = cj ? b9._gsTransform || new aR() : new aR(); var b5 = b3.scaleX < 0; var bJ = 0.00002; var b6 = 100000; var cq = 179.99; var bN = cq * bb; var bK = a2 ? parseFloat(bj(b9, ag, cn, !1, '0 0 0').split(' ')[2]) || b3.zOrigin || 0 : 0; var bL = parseFloat(aT.defaultTransformPerspective) || 0; if (bH ? ce = bj(b9, bB, cn, !0) : b9.currentStyle && (ce = b9.currentStyle.filter.match(a7), ce = ce && ce.length === 4 ? [ce[0].substr(4), Number(ce[2].substr(4)), Number(ce[1].substr(4)), ce[3].substr(4), b3.x || 0, b3.y || 0].join(',') : ''), ce && ce !== 'none' && ce !== 'matrix(1, 0, 0, 1, 0, 0)') { for (cd = (ce || '').match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], cg = cd.length; --cg > -1;) { ck = Number(cd[cg]), cd[cg] = (b8 = ck - (ck |= 0)) ? (0 | b8 * b6 + (b8 < 0 ? -0.5 : 0.5)) / b6 + ck : ck } if (cd.length === 16) { var bW = cd[8]; var ch = cd[9]; var bY = cd[10]; var bV = cd[12]; var bO = cd[13]; var b2 = cd[14]; if (b3.zOrigin && (b2 = -b3.zOrigin, bV = bW * b2 - cd[12], bO = ch * b2 - cd[13], b2 = bY * b2 + b3.zOrigin - cd[14]), !cj || ca || b3.rotationX == null) { var L; var bR; var bU; var bT; var H; var bX; var be; var ci = cd[0]; var O = cd[1]; var ae = cd[2]; var cb = cd[3]; var bS = cd[4]; var bM = cd[5]; var s = cd[6]; var b0 = cd[7]; var bP = cd[11]; var bQ = Math.atan2(s, bY); var M = -bN > bQ || bQ > bN; b3.rotationX = bQ * bc, bQ && (bT = Math.cos(-bQ), H = Math.sin(-bQ), L = bS * bT + bW * H, bR = bM * bT + ch * H, bU = s * bT + bY * H, bW = bS * -H + bW * bT, ch = bM * -H + ch * bT, bY = s * -H + bY * bT, bP = b0 * -H + bP * bT, bS = L, bM = bR, s = bU), bQ = Math.atan2(bW, ci), b3.rotationY = bQ * bc, bQ && (bX = -bN > bQ || bQ > bN, bT = Math.cos(-bQ), H = Math.sin(-bQ), L = ci * bT - bW * H, bR = O * bT - ch * H, bU = ae * bT - bY * H, ch = O * H + ch * bT, bY = ae * H + bY * bT, bP = cb * H + bP * bT, ci = L, O = bR, ae = bU), bQ = Math.atan2(O, bM), b3.rotation = bQ * bc, bQ && (be = -bN > bQ || bQ > bN, bT = Math.cos(-bQ), H = Math.sin(-bQ), ci = ci * bT + bS * H, bR = O * bT + bM * H, bM = O * -H + bM * bT, s = ae * -H + s * bT, O = bR), be && M ? b3.rotation = b3.rotationX = 0 : be && bX ? b3.rotation = b3.rotationY = 0 : bX && M && (b3.rotationY = b3.rotationX = 0), b3.scaleX = (0 | Math.sqrt(ci * ci + O * O) * b6 + 0.5) / b6, b3.scaleY = (0 | Math.sqrt(bM * bM + ch * ch) * b6 + 0.5) / b6, b3.scaleZ = (0 | Math.sqrt(s * s + bY * bY) * b6 + 0.5) / b6, b3.skewX = 0, b3.perspective = bP ? 1 / (bP < 0 ? -bP : bP) : 0, b3.x = bV, b3.y = bO, b3.z = b2 } } else { if (!(a2 && !ca && cd.length && b3.x === cd[4] && b3.y === cd[5] && (b3.rotationX || b3.rotationY) || void 0 !== b3.x && bj(b9, 'display', cn) === 'none')) { var cr = cd.length >= 6; var b1 = cr ? cd[0] : 1; var b4 = cd[1] || 0; var bZ = cd[2] || 0; var a = cr ? cd[3] : 1; b3.x = cd[4] || 0, b3.y = cd[5] || 0, cm = Math.sqrt(b1 * b1 + b4 * b4), cc = Math.sqrt(a * a + bZ * bZ), cs = b1 || b4 ? Math.atan2(b4, b1) * bc : b3.rotation || 0, cp = bZ || a ? Math.atan2(bZ, a) * bc + cs : b3.skewX || 0, co = cm - Math.abs(b3.scaleX || 0), cf = cc - Math.abs(b3.scaleY || 0), Math.abs(cp) > 90 && Math.abs(cp) < 270 && (b5 ? (cm *= -1, cp += cs <= 0 ? 180 : -180, cs += cs <= 0 ? 180 : -180) : (cc *= -1, cp += cp <= 0 ? 180 : -180)), cl = (cs - b3.rotation) % 180, b7 = (cp - b3.skewX) % 180, (void 0 === b3.skewX || co > bJ || -bJ > co || cf > bJ || -bJ > cf || cl > -cq && cq > cl && false | cl * b6 || b7 > -cq && cq > b7 && false | b7 * b6) && (b3.scaleX = cm, b3.scaleY = cc, b3.rotation = cs, b3.skewX = cp), a2 && (b3.rotationX = b3.rotationY = b3.z = 0, b3.perspective = bL, b3.scaleZ = 1) } }b3.zOrigin = bK; for (cg in b3) { bJ > b3[cg] && b3[cg] > -bJ && (b3[cg] = 0) } } else { b3 = { x: 0, y: 0, z: 0, scaleX: 1, scaleY: 1, scaleZ: 1, skewX: 0, skewY: 0, perspective: bL, rotation: 0, rotationX: 0, rotationY: 0, zOrigin: 0 } } return cj && (b9._gsTransform = b3), b3.svg = bI && b9 instanceof bI && b9.parentNode instanceof bI, b3.svg && (bp(b9, bj(b9, ag, av, !1, '50% 50%') + '', b3), am = aT.useSVGTransformAttr || ac), b3.xPercent = b3.yPercent = 0, b3 }; var aE = function (A) { var O; var K; var E = this.data; var B = -E.rotation * bb; var H = B + E.skewX * bb; var V = 100000; var G = (0 | Math.cos(B) * E.scaleX * V) / V; var J = (0 | Math.sin(B) * E.scaleX * V) / V; var L = (0 | Math.sin(H) * -E.scaleY * V) / V; var z = (0 | Math.cos(H) * E.scaleY * V) / V; var N = this.t.style; var F = this.t.currentStyle; if (F) { K = J, J = -L, L = -K, O = F.filter, N.filter = ''; var W; var Q; var I = this.t.offsetWidth; var M = this.t.offsetHeight; var y = F.position !== 'absolute'; var c = 'progid:DXImageTransform.Microsoft.Matrix(M11=' + G + ', M12=' + J + ', M21=' + L + ', M22=' + z; var x = E.x + I * E.xPercent / 100; var U = E.y + M * E.yPercent / 100; if (E.ox != null && (W = (E.oxp ? 0.01 * I * E.ox : E.ox) - I / 2, Q = (E.oyp ? 0.01 * M * E.oy : E.oy) - M / 2, x += W - (W * G + Q * J), U += Q - (W * L + Q * z)), y ? (W = I / 2, Q = M / 2, c += ', Dx=' + (W - (W * G + Q * J) + x) + ', Dy=' + (Q - (W * L + Q * z) + U) + ')') : c += ", sizingMethod='auto expand')", N.filter = O.indexOf('DXImageTransform.Microsoft.Matrix(') !== -1 ? O.replace(bs, c) : c + ' ' + O, (A === 0 || A === 1) && G === 1 && J === 0 && L === 0 && z === 1 && (y && c.indexOf('Dx=0, Dy=0') === -1 || ap.test(O) && parseFloat(RegExp.$1) !== 100 || O.indexOf('gradient(' && O.indexOf('Alpha')) === -1 && N.removeAttribute('filter')), !y) { var q; var j; var k; var D = aP < 8 ? 1 : -1; for (W = E.ieOffsetX || 0, Q = E.ieOffsetY || 0, E.ieOffsetX = Math.round((I - ((G < 0 ? -G : G) * I + (J < 0 ? -J : J) * M)) / 2 + x), E.ieOffsetY = Math.round((M - ((z < 0 ? -z : z) * M + (L < 0 ? -L : L) * I)) / 2 + U), ax = 0; ax < 4; ax++) { j = bf[ax], q = F[j], K = q.indexOf('px') !== -1 ? parseFloat(q) : bk(this.t, j, parseFloat(q), q.replace(ao, '')) || 0, k = K !== E[j] ? ax < 2 ? -E.ieOffsetX : -E.ieOffsetY : ax < 2 ? W - E.ieOffsetX : Q - E.ieOffsetY, N[j] = (E[j] = Math.round(K - k * (ax === 0 || ax === 2 ? 1 : D))) + 'px' } } } }; var bG = bm.set3DTransformRatio = function (V) { var bS; var bO; var ae; var Y; var bK; var bW; var bJ; var bM; var bP; var U; var bR; var bX; var bU; var bT; var bL; var bQ; var Q; var J; var K; var p; var M; var bV; var E; var q = this.data; var B = this.t.style; var Z = q.rotation * bb; var bN = q.scaleX; var F = q.scaleY; var be = q.scaleZ; var W = q.x; var H = q.y; var G = q.z; var I = q.perspective; if (!(V !== 1 && V !== 0 || q.force3D !== 'auto' || q.rotationY || q.rotationX || be !== 1 || I || G)) { return af.call(this, V), void 0 } if (az) { var j = 0.0001; j > bN && bN > -j && (bN = be = 0.00002), j > F && F > -j && (F = be = 0.00002), !I || q.z || q.rotationX || q.rotationY || (I = 0) } if (Z || q.skewX) { J = Math.cos(Z), K = Math.sin(Z), bS = J, bK = K, q.skewX && (Z -= q.skewX * bb, J = Math.cos(Z), K = Math.sin(Z), q.skewType === 'simple' && (p = Math.tan(q.skewX * bb), p = Math.sqrt(1 + p * p), J *= p, K *= p)), bO = -K, bW = J } else { if (!(q.rotationY || q.rotationX || be !== 1 || I || q.svg)) { return B[bH] = (q.xPercent || q.yPercent ? 'translate(' + q.xPercent + '%,' + q.yPercent + '%) translate3d(' : 'translate3d(') + W + 'px,' + H + 'px,' + G + 'px)' + (bN !== 1 || F !== 1 ? ' scale(' + bN + ',' + F + ')' : ''), void 0 }bS = bW = 1, bO = bK = 0 }bR = 1, ae = Y = bJ = bM = bP = U = bX = bU = bT = 0, bL = I ? -1 / I : 0, bQ = q.zOrigin, Q = 100000, Z = q.rotationY * bb, Z && (J = Math.cos(Z), K = Math.sin(Z), bP = bR * -K, bU = bL * -K, ae = bS * K, bJ = bK * K, bR *= J, bL *= J, bS *= J, bK *= J), Z = q.rotationX * bb, Z && (J = Math.cos(Z), K = Math.sin(Z), p = bO * J + ae * K, M = bW * J + bJ * K, bV = U * J + bR * K, E = bT * J + bL * K, ae = bO * -K + ae * J, bJ = bW * -K + bJ * J, bR = U * -K + bR * J, bL = bT * -K + bL * J, bO = p, bW = M, U = bV, bT = E), be !== 1 && (ae *= be, bJ *= be, bR *= be, bL *= be), F !== 1 && (bO *= F, bW *= F, U *= F, bT *= F), bN !== 1 && (bS *= bN, bK *= bN, bP *= bN, bU *= bN), bQ && (bX -= bQ, Y = ae * bX, bM = bJ * bX, bX = bR * bX + bQ), q.svg && (Y += q.xOrigin - (q.xOrigin * bS + q.yOrigin * bO), bM += q.yOrigin - (q.xOrigin * bK + q.yOrigin * bW)), Y = (p = (Y += W) - (Y |= 0)) ? (0 | p * Q + (p < 0 ? -0.5 : 0.5)) / Q + Y : Y, bM = (p = (bM += H) - (bM |= 0)) ? (0 | p * Q + (p < 0 ? -0.5 : 0.5)) / Q + bM : bM, bX = (p = (bX += G) - (bX |= 0)) ? (0 | p * Q + (p < 0 ? -0.5 : 0.5)) / Q + bX : bX, B[bH] = (q.xPercent || q.yPercent ? 'translate(' + q.xPercent + '%,' + q.yPercent + '%) matrix3d(' : 'matrix3d(') + [(0 | bS * Q) / Q, (0 | bK * Q) / Q, (0 | bP * Q) / Q, (0 | bU * Q) / Q, (0 | bO * Q) / Q, (0 | bW * Q) / Q, (0 | U * Q) / Q, (0 | bT * Q) / Q, (0 | ae * Q) / Q, (0 | bJ * Q) / Q, (0 | bR * Q) / Q, (0 | bL * Q) / Q, Y, bM, bX, I ? 1 + -bX / I : 1].join(',') + ')' }; var af = bm.set2DTransformRatio = function (F) { var z; var w; var b; var G; var k; var C; var j; var v; var x; var E; var y; var g = this.data; var D = this.t; var B = D.style; var A = g.x; var q = g.y; return !(g.rotationX || g.rotationY || g.z || g.force3D === !0 || g.force3D === 'auto' && F !== 1 && F !== 0) || g.svg && am || !a2 ? (G = g.scaleX, k = g.scaleY, g.rotation || g.skewX || g.svg ? (z = g.rotation * bb, w = z - g.skewX * bb, b = 100000, C = Math.cos(z) * G, j = Math.sin(z) * G, v = Math.sin(w) * -k, x = Math.cos(w) * k, g.svg && (A += g.xOrigin - (g.xOrigin * C + g.yOrigin * v), q += g.yOrigin - (g.xOrigin * j + g.yOrigin * x), y = 0.000001, y > A && A > -y && (A = 0), y > q && q > -y && (q = 0)), E = (0 | C * b) / b + ',' + (0 | j * b) / b + ',' + (0 | v * b) / b + ',' + (0 | x * b) / b + ',' + A + ',' + q + ')', g.svg && am ? D.setAttribute('transform', 'matrix(' + E) : B[bH] = (g.xPercent || g.yPercent ? 'translate(' + g.xPercent + '%,' + g.yPercent + '%) matrix(' : 'matrix(') + E) : B[bH] = (g.xPercent || g.yPercent ? 'translate(' + g.xPercent + '%,' + g.yPercent + '%) matrix(' : 'matrix(') + G + ',0,0,' + k + ',' + A + ',' + q + ')', void 0) : (this.setRatio = bG, bG.call(this, F), void 0) }; bw('transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent', { parser: function (s, I, E, w, B, A, D) { if (w._transform) { return B } var F; var q; var H; var z; var L; var K; var J; var C = w._transform = bD(s, av, !0, D.parseTransform); var G = s.style; var k = 0.000001; var b = bA.length; var j = D; var a = {}; if (typeof j.transform === 'string' && bH) { H = aX.style, H[bH] = j.transform, H.display = 'block', H.position = 'absolute', an.body.appendChild(aX), F = bD(aX, null, !1), an.body.removeChild(aX) } else { if (typeof j === 'object') { if (F = { scaleX: bF(j.scaleX != null ? j.scaleX : j.scale, C.scaleX), scaleY: bF(j.scaleY != null ? j.scaleY : j.scale, C.scaleY), scaleZ: bF(j.scaleZ, C.scaleZ), x: bF(j.x, C.x), y: bF(j.y, C.y), z: bF(j.z, C.z), xPercent: bF(j.xPercent, C.xPercent), yPercent: bF(j.yPercent, C.yPercent), perspective: bF(j.transformPerspective, C.perspective) }, J = j.directionalRotation, J != null) { if (typeof J === 'object') { for (H in J) { j[H] = J[H] } } else { j.rotation = J } } typeof j.x === 'string' && j.x.indexOf('%') !== -1 && (F.x = 0, F.xPercent = bF(j.x, C.xPercent)), typeof j.y === 'string' && j.y.indexOf('%') !== -1 && (F.y = 0, F.yPercent = bF(j.y, C.yPercent)), F.rotation = bx('rotation' in j ? j.rotation : 'shortRotation' in j ? j.shortRotation + '_short' : 'rotationZ' in j ? j.rotationZ : C.rotation, C.rotation, 'rotation', a), a2 && (F.rotationX = bx('rotationX' in j ? j.rotationX : 'shortRotationX' in j ? j.shortRotationX + '_short' : C.rotationX || 0, C.rotationX, 'rotationX', a), F.rotationY = bx('rotationY' in j ? j.rotationY : 'shortRotationY' in j ? j.shortRotationY + '_short' : C.rotationY || 0, C.rotationY, 'rotationY', a)), F.skewX = j.skewX == null ? C.skewX : bx(j.skewX, C.skewX), F.skewY = j.skewY == null ? C.skewY : bx(j.skewY, C.skewY), (q = F.skewY - C.skewY) && (F.skewX += q, F.rotation += q) } } for (a2 && j.force3D != null && (C.force3D = j.force3D, K = !0), C.skewType = j.skewType || C.skewType || aT.defaultSkewType, L = C.force3D || C.z || C.rotationX || C.rotationY || F.z || F.rotationX || F.rotationY || F.perspective, L || j.scale == null || (F.scaleZ = 1); --b > -1;) { E = bA[b], z = F[E] - C[E], (z > k || -k > z || j[E] != null || a9[E] != null) && (K = !0, B = new al(C, E, C[E], z, B), E in a && (B.e = a[E]), B.xs0 = 0, B.plugin = A, w._overwriteProps.push(B.n)) } return z = j.transformOrigin, z && C.svg && (bp(s, z, F), B = new al(C, 'xOrigin', C.xOrigin, F.xOrigin - C.xOrigin, B, -1, 'transformOrigin'), B.b = C.xOrigin, B.e = B.xs0 = F.xOrigin, B = new al(C, 'yOrigin', C.yOrigin, F.yOrigin - C.yOrigin, B, -1, 'transformOrigin'), B.b = C.yOrigin, B.e = B.xs0 = F.yOrigin, z = '0px 0px'), (z || a2 && L && C.zOrigin) && (bH ? (K = !0, E = ag, z = (z || bj(s, E, av, !1, '50% 50%')) + '', B = new al(G, E, 0, 0, B, -1, 'transformOrigin'), B.b = G[E], B.plugin = A, a2 ? (H = C.zOrigin, z = z.split(' '), C.zOrigin = (z.length > 2 && (H === 0 || z[2] !== '0px') ? parseFloat(z[2]) : H) || 0, B.xs0 = B.e = z[0] + ' ' + (z[1] || '50%') + ' 0px', B = new al(C, 'zOrigin', 0, 0, B, -1, B.n), B.b = H, B.xs0 = B.e = C.zOrigin) : B.xs0 = B.e = z) : ab(z + '', C)), K && (w._transformType = C.svg && am || !L && this._transformType !== 3 ? 2 : 3), B }, prefix: !0 }), bw('boxShadow', { defaultValue: '0px 0px 0px 0px #999', prefix: !0, color: !0, multi: !0, keyword: 'inset' }), bw('borderRadius', { defaultValue: '0px', parser: function (B, L, H, E, Q) { L = this.format(L); var D; var G; var I; var A; var K; var C; var R; var N; var M; var F; var J; var z; var q; var r; var j; var s; var O = ['borderTopLeftRadius', 'borderTopRightRadius', 'borderBottomRightRadius', 'borderBottomLeftRadius']; var k = B.style; for (M = parseFloat(B.offsetWidth), F = parseFloat(B.offsetHeight), D = L.split(' '), G = 0; O.length > G; G++) { this.p.indexOf('border') && (O[G] = aZ(O[G])), K = A = bj(B, O[G], av, !1, '0px'), K.indexOf(' ') !== -1 && (A = K.split(' '), K = A[0], A = A[1]), C = I = D[G], R = parseFloat(K), z = K.substr((R + '').length), q = C.charAt(1) === '=', q ? (N = parseInt(C.charAt(0) + '1', 10), C = C.substr(2), N *= parseFloat(C), J = C.substr((N + '').length - (N < 0 ? 1 : 0)) || '') : (N = parseFloat(C), J = C.substr((N + '').length)), J === '' && (J = aw[H] || z), J !== z && (r = bk(B, 'borderLeft', R, z), j = bk(B, 'borderTop', R, z), J === '%' ? (K = 100 * (r / M) + '%', A = 100 * (j / F) + '%') : J === 'em' ? (s = bk(B, 'borderLeft', 1, 'em'), K = r / s + 'em', A = j / s + 'em') : (K = r + 'px', A = j + 'px'), q && (C = parseFloat(K) + N + J, I = parseFloat(A) + N + J)), Q = aa(k, O[G], K + ' ' + A, C + ' ' + I, !1, '0px', Q) } return Q }, prefix: !0, formatter: a8('0px 0px 0px 0px', !1, !0) }), bw('backgroundPosition', { defaultValue: '0 0', parser: function (E, z, v, b, k, B) { var j; var s; var w; var D; var y; var c; var C = 'background-position'; var A = av || ay(E, null); var q = this.format((A ? aP ? A.getPropertyValue(C + '-x') + ' ' + A.getPropertyValue(C + '-y') : A.getPropertyValue(C) : E.currentStyle.backgroundPositionX + ' ' + E.currentStyle.backgroundPositionY) || '0 0'); var x = this.format(z); if (q.indexOf('%') !== -1 != (x.indexOf('%') !== -1) && (c = bj(E, 'backgroundImage').replace(a4, ''), c && c !== 'none')) { for (j = q.split(' '), s = x.split(' '), bg.setAttribute('src', c), w = 2; --w > -1;) { q = j[w], D = q.indexOf('%') !== -1, D !== (s[w].indexOf('%') !== -1) && (y = w === 0 ? E.offsetWidth - bg.width : E.offsetHeight - bg.height, j[w] = D ? parseFloat(q) / 100 * y + 'px' : 100 * (parseFloat(q) / y) + '%') }q = j.join(' ') } return this.parseComplex(E.style, q, x, k, B) }, formatter: ab }), bw('backgroundSize', { defaultValue: '0 0', formatter: ab }), bw('perspective', { defaultValue: '0px', prefix: !0 }), bw('perspectiveOrigin', { defaultValue: '50% 50%', prefix: !0 }), bw('transformStyle', { prefix: !0 }), bw('backfaceVisibility', { prefix: !0 }), bw('userSelect', { prefix: !0 }), bw('margin', { parser: aQ('marginTop,marginRight,marginBottom,marginLeft') }), bw('padding', { parser: aQ('paddingTop,paddingRight,paddingBottom,paddingLeft') }), bw('clip', { defaultValue: 'rect(0px,0px,0px,0px)', parser: function (p, k, g, b, d, m) { var c, f, j; return aP < 9 ? (f = p.currentStyle, j = aP < 8 ? ' ' : ',', c = 'rect(' + f.clipTop + j + f.clipRight + j + f.clipBottom + j + f.clipLeft + ')', k = this.format(k).split(',').join(j)) : (c = this.format(bj(p, this.p, av, !1, this.dflt)), k = this.format(k)), this.parseComplex(p.style, c, k, d, m) } }), bw('textShadow', { defaultValue: '0px 0px 0px #999', color: !0, multi: !0 }), bw('autoRound,strictUnits', { parser: function (b, f, a, d, c) { return c } }), bw('border', { defaultValue: '0px solid #000', parser: function (d, g, c, f, h, b) { return this.parseComplex(d.style, this.format(bj(d, 'borderTopWidth', av, !1, '0px') + ' ' + bj(d, 'borderTopStyle', av, !1, 'solid') + ' ' + bj(d, 'borderTopColor', av, !1, '#000')), this.format(g), h, b) }, color: !0, formatter: function (a) { var b = a.split(' '); return b[0] + ' ' + (b[1] || 'solid') + ' ' + (a.match(bE) || ['#000'])[0] } }), bw('borderWidth', { parser: aQ('borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth') }), bw('float,cssFloat,styleFloat', { parser: function (d, h, c, g, f) { var j = d.style; var b = 'cssFloat' in j ? 'cssFloat' : 'styleFloat'; return new al(j, b, 0, 0, f, -1, c, !1, 0, j[b], h) } }); var by = function (b) { var f; var a = this.t; var d = a.filter || bj(this.data, 'filter') || ''; var c = 0 | this.s + this.c * b; c === 100 && (d.indexOf('atrix(') === -1 && d.indexOf('radient(') === -1 && d.indexOf('oader(') === -1 ? (a.removeAttribute('filter'), f = !bj(this.data, 'filter')) : (a.filter = d.replace(aq, ''), f = !0)), f || (this.xn1 && (a.filter = d = d || 'alpha(opacity=' + c + ')'), d.indexOf('pacity') === -1 ? c === 0 && this.xn1 || (a.filter = d + ' alpha(opacity=' + c + ')') : a.filter = d.replace(ap, 'opacity=' + c)) }; bw('opacity,alpha,autoAlpha', { defaultValue: '1', parser: function (p, k, g, b, d, m) { var c = parseFloat(bj(p, 'opacity', av, !1, '1')); var f = p.style; var j = g === 'autoAlpha'; return typeof k === 'string' && k.charAt(1) === '=' && (k = (k.charAt(0) === '-' ? -1 : 1) * parseFloat(k.substr(2)) + c), j && c === 1 && bj(p, 'visibility', av) === 'hidden' && k !== 0 && (c = 0), aW ? d = new al(f, 'opacity', c, k - c, d) : (d = new al(f, 'opacity', 100 * c, 100 * (k - c), d), d.xn1 = j ? 1 : 0, f.zoom = 1, d.type = 2, d.b = 'alpha(opacity=' + d.s + ')', d.e = 'alpha(opacity=' + (d.s + d.c) + ')', d.data = p, d.plugin = m, d.setRatio = by), j && (d = new al(f, 'visibility', 0, 0, d, -1, null, !1, 0, c !== 0 ? 'inherit' : 'hidden', k === 0 ? 'hidden' : 'inherit'), d.xs0 = 'inherit', b._overwriteProps.push(d.n), b._overwriteProps.push(g)), d } }); var bt = function (a, b) { b && (a.removeProperty ? (b.substr(0, 2) === 'ms' && (b = 'M' + b.substr(1)), a.removeProperty(b.replace(a6, '-$1').toLowerCase())) : a.removeAttribute(b)) }; var ai = function (b) { if (this.t._gsClassPT = this, b === 1 || b === 0) { this.t.setAttribute('class', b === 0 ? this.b : this.e); for (var c = this.data, a = this.t.style; c;) { c.v ? a[c.p] = c.v : bt(a, c.p), c = c._next }b === 1 && this.t._gsClassPT === this && (this.t._gsClassPT = null) } else { this.t.getAttribute('class') !== this.e && this.t.setAttribute('class', this.e) } }; bw('className', { parser: function (A, s, b, j, x, i, k) { var m; var z; var q; var g; var y; var w = A.getAttribute('class') || ''; var v = A.style.cssText; if (x = j._classNamePT = new al(A, b, 0, 0, x, 2), x.setRatio = ai, x.pr = -11, aI = !0, x.b = w, z = aV(A, av), q = A._gsClassPT) { for (g = {}, y = q.data; y;) { g[y.p] = 1, y = y._next }q.setRatio(1) } return A._gsClassPT = x, x.e = s.charAt(1) !== '=' ? s : w.replace(RegExp('\\s*\\b' + s.substr(2) + '\\b'), '') + (s.charAt(0) === '+' ? ' ' + s.substr(2) : ''), j._tween._duration && (A.setAttribute('class', x.e), m = bz(A, z, aV(A), k, g), A.setAttribute('class', w), x.data = m.firstMPT, A.style.cssText = v, x = x.xfirst = j.parse(A, m.difs, x, i)), x } }); var bi = function (d) { if ((d === 1 || d === 0) && this.data._totalTime === this.data._totalDuration && this.data.data !== 'isFromStart') { var h; var c; var g; var f; var j = this.t.style; var b = aA.transform.parse; if (this.e === 'all') { j.cssText = '', f = !0 } else { for (h = this.e.split(' ').join('').split(','), g = h.length; --g > -1;) { c = h[g], aA[c] && (aA[c].parse === b ? f = !0 : c = c === 'transformOrigin' ? ag : aA[c].p), bt(j, c) } }f && (bt(j, bH), this.t._gsTransform && delete this.t._gsTransform) } }; for (bw('clearProps', { parser: function (a, d, c, b, f) { return f = new al(a, c, 0, 0, f, 2), f.setRatio = bi, f.e = d, f.pr = -10, f.data = b._tween, aI = !0, f } }), aF = 'bezier,throwProps,physicsProps,physics2D'.split(','), ax = aF.length; ax--;) { bv(aF[ax]) }aF = aT.prototype, aF._firstPT = null, aF._onInitTween = function (z, j, b) { if (!z.nodeType) { return !1 } this._target = z, this._tween = b, this._vars = j, aJ = j.autoRound, aI = !1, aw = j.suffixMap || aT.suffixMap, av = ay(z, ''), aB = this._overwriteProps; var h; var a; var n; var k; var f; var i; var u; var q; var r; var s = z.style; if (at && s.zIndex === '' && (h = bj(z, 'zIndex', av), (h === 'auto' || h === '') && this._addLazySet(s, 'zIndex', 0)), typeof j === 'string' && (k = s.cssText, h = aV(z, av), s.cssText = k + ';' + j, h = bz(z, h, aV(z)).difs, !aW && a1.test(j) && (h.opacity = parseFloat(RegExp.$1)), j = h, s.cssText = k), this._firstPT = a = this.parse(z, j, null), this._transformType) { for (r = this._transformType === 3, bH ? aM && (at = !0, s.zIndex === '' && (u = bj(z, 'zIndex', av), (u === 'auto' || u === '') && this._addLazySet(s, 'zIndex', 0)), aU && this._addLazySet(s, 'WebkitBackfaceVisibility', this._vars.WebkitBackfaceVisibility || (r ? 'visible' : 'hidden'))) : s.zoom = 1, n = a; n && n._next;) { n = n._next }q = new al(z, 'transform', 0, 0, null, 2), this._linkCSSP(q, null, n), q.setRatio = r && a2 ? bG : bH ? af : aE, q.data = this._transform || bD(z, av, !0), aB.pop() } if (aI) { for (;a;) { for (i = a._next, n = k; n && n.pr > a.pr;) { n = n._next }(a._prev = n ? n._prev : f) ? a._prev._next = a : k = a, (a._next = n) ? n._prev = a : f = a, a = i } this._firstPT = k } return !0 }, aF.parse = function (C, s, o, h) { var y; var k; var B; var r; var b; var A; var x; var w; var j; var q; var z = C.style; for (y in s) { A = s[y], k = aA[y], k ? o = k.parse(C, A, y, this, o, h, s) : (b = bj(C, y, av) + '', j = typeof A === 'string', y === 'color' || y === 'fill' || y === 'stroke' || y.indexOf('Color') !== -1 || j && aS.test(A) ? (j || (A = aK(A), A = (A.length > 3 ? 'rgba(' : 'rgb(') + A.join(',') + ')'), o = aa(z, y, b, A, !0, 'transparent', o, 0, h)) : !j || A.indexOf(' ') === -1 && A.indexOf(',') === -1 ? (B = parseFloat(b), x = B || B === 0 ? b.substr((B + '').length) : '', (b === '' || b === 'auto') && (y === 'width' || y === 'height' ? (B = bo(C, y, av), x = 'px') : y === 'left' || y === 'top' ? (B = a5(C, y, av), x = 'px') : (B = y !== 'opacity' ? 0 : 1, x = '')), q = j && A.charAt(1) === '=', q ? (r = parseInt(A.charAt(0) + '1', 10), A = A.substr(2), r *= parseFloat(A), w = A.replace(ao, '')) : (r = parseFloat(A), w = j ? A.substr((r + '').length) || '' : ''), w === '' && (w = y in aw ? aw[y] : x), A = r || r === 0 ? (q ? r + B : r) + w : s[y], x !== w && w !== '' && (r || r === 0) && B && (B = bk(C, y, B, x), w === '%' ? (B /= bk(C, y, 100, '%') / 100, s.strictUnits !== !0 && (b = B + '%')) : w === 'em' ? B /= bk(C, y, 1, 'em') : w !== 'px' && (r = bk(C, y, r, w), w = 'px'), q && (r || r === 0) && (A = r + B + w)), q && (r += B), !B && B !== 0 || !r && r !== 0 ? void 0 !== z[y] && (A || A + '' != 'NaN' && A != null) ? (o = new al(z, y, r || B || 0, 0, o, -1, y, !1, 0, b, A), o.xs0 = A !== 'none' || y !== 'display' && y.indexOf('Style') === -1 ? A : b) : a0('invalid ' + y + ' tween value: ' + s[y]) : (o = new al(z, y, B, r - B, o, 0, y, aJ !== !1 && (w === 'px' || y === 'zIndex'), 0, b, A), o.xs0 = w)) : o = aa(z, y, b, A, !0, null, o, 0, h)), h && o && !o.plugin && (o.plugin = h) } return o }, aF.setRatio = function (b) { var f; var a; var d; var c = this._firstPT; var g = 0.000001; if (b !== 1 || this._tween._time !== this._tween._duration && this._tween._time !== 0) { if (b || this._tween._time !== this._tween._duration && this._tween._time !== 0 || this._tween._rawPrevTime === -0.000001) { for (;c;) { if (f = c.c * b + c.s, c.r ? f = Math.round(f) : g > f && f > -g && (f = 0), c.type) { if (c.type === 1) { if (d = c.l, d === 2) { c.t[c.p] = c.xs0 + f + c.xs1 + c.xn1 + c.xs2 } else { if (d === 3) { c.t[c.p] = c.xs0 + f + c.xs1 + c.xn1 + c.xs2 + c.xn2 + c.xs3 } else { if (d === 4) { c.t[c.p] = c.xs0 + f + c.xs1 + c.xn1 + c.xs2 + c.xn2 + c.xs3 + c.xn3 + c.xs4 } else { if (d === 5) { c.t[c.p] = c.xs0 + f + c.xs1 + c.xn1 + c.xs2 + c.xn2 + c.xs3 + c.xn3 + c.xs4 + c.xn4 + c.xs5 } else { for (a = c.xs0 + f + c.xs1, d = 1; c.l > d; d++) { a += c['xn' + d] + c['xs' + (d + 1)] }c.t[c.p] = a } } } } } else { c.type === -1 ? c.t[c.p] = c.xs0 : c.setRatio && c.setRatio(b) } } else { c.t[c.p] = f + c.xs0 }c = c._next } } else { for (;c;) { c.type !== 2 ? c.t[c.p] = c.b : c.setRatio(b), c = c._next } } } else { for (;c;) { c.type !== 2 ? c.t[c.p] = c.e : c.setRatio(b), c = c._next } } }, aF._enableTransforms = function (a) { this._transform = this._transform || bD(this._target, av, !0), this._transformType = this._transform.svg && am || !a && this._transformType !== 3 ? 2 : 3 }; var ak = function () { this.t[this.p] = this.e, this.data._linkCSSP(this, this._next, null, !0) }; aF._addLazySet = function (b, d, a) { var c = this._firstPT = new al(b, d, 0, 0, this._firstPT, 2); c.e = a, c.setRatio = ak, c.data = this }, aF._linkCSSP = function (b, d, a, c) { return b && (d && (d._prev = b), b._next && (b._next._prev = b._prev), b._prev ? b._prev._next = b._next : this._firstPT === b && (this._firstPT = b._next, c = !0), a ? a._next = b : c || this._firstPT !== null || (this._firstPT = b), b._next = d, b._prev = a), b }, aF._kill = function (d) { var a; var c; var b; var f = d; if (d.autoAlpha || d.alpha) { f = {}; for (c in d) { f[c] = d[c] }f.opacity = 1, f.autoAlpha && (f.visibility = 1) } return d.className && (a = this._classNamePT) && (b = a.xfirst, b && b._prev ? this._linkCSSP(b._prev, a._next, b._prev._prev) : b === this._firstPT && (this._firstPT = a._next), a._next && this._linkCSSP(a._next, a._next._next, b._prev), this._classNamePT = null), au.prototype._kill.call(this, f) }; var ad = function (d, h, c) { var g, f, j, b; if (d.slice) { for (f = d.length; --f > -1;) { ad(d[f], h, c) } } else { for (g = d.childNodes, f = g.length; --f > -1;) { j = g[f], b = j.type, j.style && (h.push(aV(j)), c && c.push(j)), b !== 1 && b !== 9 && b !== 11 || !j.childNodes.length || ad(j, h, c) } } }; return aT.cascadeTo = function (x, k, b) { var y; var g; var v; var d = aN.to(x, k, b); var j = [d]; var m = []; var w = []; var q = []; var c = aN._internals.reservedProps; for (x = d._targets || d.target, ad(x, m, q), d.render(k, !0), ad(x, w), d.render(0, !0), d._enabled(!0), y = q.length; --y > -1;) { if (g = bz(q[y], m[y], w[y]), g.firstMPT) { g = g.difs; for (v in b) { c[v] && (g[v] = b[v]) }j.push(aN.to(q[y], k, g)) } } return j }, au.activate([aT]), aT }, !0) }), _gsScope._gsDefine && _gsScope._gsQueue.pop()(), (function (a) { var b = function () { return (_gsScope.GreenSockGlobals || _gsScope)[a] }; typeof define === 'function' && define.amd ? define(['TweenLite'], b) : typeof module !== 'undefined' && module.exports && (require('../TweenLite.js'), module.exports = b()) }('CSSPlugin'))
/*!
 * VERSION: beta 0.3.3
 * DATE: 2014-10-29
 * UPDATES AND DOCS AT: http://www.greensock.com
